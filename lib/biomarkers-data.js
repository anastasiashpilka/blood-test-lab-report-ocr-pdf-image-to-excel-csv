const biomarkersData = [
    ...
    `,
    relatedBiomarkers: ['Hemoglobin (HGB)', 'Hematocrit (HCT)', 'Mean Corpuscular Volume (MCV)', 'Red Cell Distribution Width (RDW)']
    },
    {
    id: 'Hemoglobin (HGB)',
    name: 'Hemoglobin (HGB)',
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Hematocrit (HCT)', 'Mean Corpuscular Hemoglobin (MCH)', 'Mean Corpuscular Hemoglobin Concentration (MCHC)']
},
    {
    id: 'Hematocrit (HCT)',
    name: 'Hematocrit (HCT)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Hematocrit (HCT) is a vital measurement included in a Complete Blood Count (CBC). It represents the <strong>volume percentage of red blood cells (RBCs) in a sample of whole blood</strong>.</p>

        <h3>Role and Function:</h3>
        <p>Hematocrit directly reflects the proportion of your blood that is made up of oxygen-carrying red blood cells. It's an indirect measure of the blood's <strong>oxygen-carrying capacity</strong> and its <strong>viscosity</strong> (thickness). A higher hematocrit means a greater proportion of red blood cells, which generally translates to more oxygen being delivered to tissues, but also thicker blood.</p>
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Hemoglobin (HGB)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Mean Corpuscular Volume (MCV) is one of the "red blood cell indices" included in a Complete Blood Count (CBC). It provides a quantitative measure of the <strong>average volume or size of individual red blood cells (RBCs)</strong>.</p>

        <h3>Role and Function:</h3>
        <p>The primary role of MCV is in the <strong>morphological classification of anemia</strong>. By determining the average size of red blood cells, MCV helps narrow down the potential causes of anemia, categorizing it as microcytic (small cells), normocytic (normal cells), or macrocytic (large cells). This classification is critical for guiding further diagnostic tests and treatment strategies.</p>
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Mean Corpuscular Hemoglobin (MCH)', 'Mean Corpuscular Hemoglobin Concentration (MCHC)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Mean Corpuscular Hemoglobin (MCH) is one of the red blood cell indices included in a Complete Blood Count (CBC). It quantifies the <strong>average weight or absolute amount of hemoglobin contained in a single red blood cell (RBC)</strong>.</p>

        <h3>Role and Function:</h3>
        <p>MCH helps in the <strong>classification of anemia</strong> by indicating how much hemoglobin, the oxygen-carrying protein, is present in an average red blood cell. It is particularly useful when interpreted alongside MCV (Mean Corpuscular Volume) and MCHC (Mean Corpuscular Hemoglobin Concentration) to characterize the morphology of red blood cells and diagnose specific types of anemia.</p>
        ...
        <ul>
            ...
            <li><strong>MCH vs. MCHC:</strong> MCH measures the <strong>amount</strong> of hemoglobin per cell, while MCHC (Mean Corpuscular Hemoglobin Concentration) measures the <strong>concentration</strong> of hemoglobin within a given volume of red blood cells. MCHC is often considered a more reliable indicator of hypochromia, as it accounts for the cell's volume. However, both provide valuable information about hemoglobin content.</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Hemoglobin (HGB)', 'Mean Corpuscular Volume (MCV)', 'Mean Corpuscular Hemoglobin Concentration (MCHC)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Mean Corpuscular Hemoglobin Concentration (MCHC) is another important red blood cell index provided as part of a Complete Blood Count (CBC). It measures the <strong>average concentration of hemoglobin within a given volume of packed red blood cells</strong>.</p>

        <h3>Role and Function:</h3>
        <p>MCHC is a crucial indicator of the <strong>color intensity or "fullness" of red blood cells</strong> with hemoglobin. It helps classify anemias based on this characteristic: cells with low MCHC are termed "hypochromic" (pale), while those with normal MCHC are "normochromic." True "hyperchromia" (high MCHC) is rare and often points to specific red blood cell abnormalities rather than an excess of hemoglobin in normal cells.</p>
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Hemoglobin (HGB)', 'Mean Corpuscular Volume (MCV)', 'Mean Corpuscular Hemoglobin (MCH)']
    },
    {
    ...
    detailedInfo: `
        ...
        <h3>Low RDW:</h3>
        <p>A low RDW means that the red blood cells are very uniform in size, with little variation. A low RDW is generally <strong>not considered clinically significant</strong> and indicates a healthy and homogeneous red blood cell population. It is usually a normal finding.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>RDW is particularly useful in the <strong>differential diagnosis of anemias</strong>, especially when considered alongside MCV:</p>
        <ul>
            <li><strong>Normal MCV with High RDW:</strong> This pattern can indicate early iron deficiency anemia, early B12/folate deficiency, or dimorphic anemia (a mixture of microcytic and macrocytic cells, e.g., iron deficiency with megaloblastic anemia). It can also be seen in chronic liver disease or myelodysplastic syndromes.</li>
            <li><strong>Low MCV with High RDW:</strong> Strongly suggestive of iron deficiency anemia.</li>
            <li><strong>Low MCV with Normal RDW:</strong> Often points towards thalassemia trait or chronic disease anemia (though ACD can also have a normal RDW).</li>
            <li><strong>High MCV with High RDW:</strong> Characteristic of Vitamin B12 or folate deficiency (megaloblastic anemias).</li>
            <li><strong>High MCV with Normal RDW:</strong> Less common, but can be seen in aplastic anemia or pre-leukemia.</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Mean Corpuscular Volume (MCV)']
    },
    {
    id: 'White Blood Cell Count (WBC)',
    ...
    detailedInfo: `
        ...
        <h3>Additional Information:</h3>
        <p>The total WBC count provides a general overview of the immune system's status. However, for a more detailed understanding, it is crucial to analyze the <strong>WBC Differential Count</strong>, which breaks down the total WBCs into their five main types:</p>
        <ul>
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Neutrophils are the most abundant type of white blood cell (WBC) and are a key component of the <strong>White Blood Cell Differential</strong>, which breaks down the total WBC count into its specific cell types. They are granular leukocytes, meaning they contain granules in their cytoplasm.</p>

        <h3>Role and Function:</h3>
        <p>Neutrophils are the <strong>first responders</strong> to infection and inflammation, particularly against <strong>bacterial and fungal pathogens</strong>. Their primary function is <strong>phagocytosis</strong>, a process where they engulf and digest harmful microorganisms, foreign particles, and cellular debris. They are rapidly mobilized from the bone marrow to sites of infection, forming a crucial part of the innate immune response.</p>
    ...
    `,
    relatedBiomarkers: ['White Blood Cell Count (WBC)', 'White Blood Cell Differential (Neutrophils, Lymphocytes, Monocytes, Eosinophils, Basophils)', 'Monocytes', 'Eosinophils', 'Basophils'] 
    },
    {
    id: 'White Blood Cell Differential (Neutrophils, Lymphocytes, Monocytes, Eosinophils, Basophils)',
    name: 'Lymphocytes',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lymphocytes are a crucial type of white blood cell (WBC) and a key component of the <strong>White Blood Cell Differential</strong>. They are part of the adaptive immune system, providing specific and long-lasting immunity against pathogens.</p>

        <h3>Role and Function:</h3>
        <p>Lymphocytes are fundamental to the body's <strong>adaptive immune response</strong>. They are primarily responsible for targeting and eliminating viruses, but also play roles in fighting bacteria, fungi, and cancer cells. There are two main types:</p>
        <ul>
        ...
        <ul>
            ...
            <li><strong>Leukemias:</strong> Certain types of blood cancers, particularly <strong>Chronic Lymphocytic Leukemia (CLL)</strong> and Acute Lymphocytic Leukemia (ALL), involve uncontrolled proliferation of abnormal lymphocytes, leading to very high counts.</li>
    ...
    `,
    relatedBiomarkers: ['White Blood Cell Count (WBC)', 'Neutrophils', 'Monocytes', 'Eosinophils', 'Basophils'] // Added all WBC components as related
},
    {
    id: 'Monocytes',
    name: 'Monocytes',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Monocytes are a type of white blood cell (WBC) and are part of the <strong>White Blood Cell Differential</strong>. They are the largest type of leukocyte and play a crucial role in both the innate and adaptive immune systems.</p>

        <h3>Role and Function:</h3>
        <p>Monocytes circulate in the bloodstream for a relatively short period before migrating into tissues, where they mature and differentiate into <strong>macrophages</strong> and dendritic cells. In their mature forms, they perform several vital immune functions:</p>
        <ul>
        ...
        <p>When interpreting monocyte counts, it's essential to consider the <strong>Absolute Monocyte Count (AMC)</strong>, as a percentage alone can be misleading if the total WBC count is abnormal. For instance, a normal percentage with a very low total WBC count would still mean a low absolute number of monocytes.</p>
    ...
    `,
    relatedBiomarkers: ['White Blood Cell Count (WBC)', 'Neutrophils', 'lymphocytes', 'Eosinophils', 'Basophils'] 
    },
    {
    id: 'Eosinophils',
    name: 'Eosinophils',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Eosinophils are a type of granulocytic white blood cell (WBC) and a component of the <strong>White Blood Cell Differential</strong>. They are characterized by granules in their cytoplasm that stain bright red with eosin dye.</p>
    ...
    `,
    relatedBiomarkers: ['White Blood Cell Count (WBC)', 'Neutrophils', 'lymphocytes', 'Monocytes', 'Basophils'] 
    },
    {
    id: 'Basophils',
    name: 'Basophils',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Basophils are the least common type of white blood cell (WBC) and are a component of the <strong>White Blood Cell Differential</strong>. They are a type of granulocyte, characterized by large, dark-staining granules in their cytoplasm that contain various inflammatory mediators.</p>

        <h3>Role and Function:</h3>
        <p>Basophils play a critical role in <strong>allergic reactions and inflammatory responses</strong>, particularly immediate hypersensitivity reactions. Their main functions include:</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['White Blood Cell Count (WBC)', 'Neutrophils', 'lymphocytes', 'Monocytes', 'Eosinophils'] 
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Platelets, also known as thrombocytes, are small, anucleated cell fragments derived from megakaryocytes in the bone marrow. They are a critical component of the <strong>Complete Blood Count (CBC)</strong> and play a central role in blood clotting.</p>

        <h3>Role and Function:</h3>
        <p>Platelets are essential for <strong>hemostasis</strong>, the process by which the body stops bleeding. Their key functions include:</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Platelet count is a fundamental parameter for assessing a patient's risk of bleeding or clotting. While the total count is important, other platelet indices, such as <strong>Mean Platelet Volume (MPV)</strong>, can provide additional diagnostic clues.</p>
    ...
    `,
    relatedBiomarkers: ['Mean Platelet Volume (MPV)', 'd-dimer']
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Mean Platelet Volume (MPV) is one of the platelet indices included in a Complete Blood Count (CBC). It measures the <strong>average size of platelets</strong> in a blood sample.</p>

        <h3>Role and Function:</h3>
        <p>MPV provides insight into platelet production and activity. Generally, <strong>larger platelets are younger, more reactive, and often more functionally active</strong> than smaller, older platelets. A higher MPV can indicate that the bone marrow is rapidly producing new platelets, often in response to increased demand or destruction of existing platelets. A lower MPV might suggest impaired platelet production or a predominance of older, less active platelets.</p>
    ...
    `,
    relatedBiomarkers: ['Platelet Count (PLT)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Erythrocyte Sedimentation Rate (ESR), also known as "sed rate," is a simple, non-specific blood test that measures the <strong>rate at which red blood cells (erythrocytes) settle to the bottom of a vertical tube of blood in one hour</strong>. The test is influenced by the presence of certain proteins, especially acute phase reactants, which increase in concentration during inflammation.</p>

        <h3>Role and Function:</h3>
        <p>ESR is an <strong>indirect measure of inflammation</strong> in the body. When inflammation is present, increased levels of acute phase proteins (like fibrinogen and immunoglobulins) cause red blood cells to clump together and settle more quickly than usual. It is a non-specific test, meaning it can indicate inflammation but does not pinpoint the cause or location of the inflammation.</p>
    ...
    `,
    relatedBiomarkers: ['C-reactive protein (CRP)', 'pct']
},
{
    id: 'Glucose',
    name: 'Glucose',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Glucose is a simple sugar that serves as the body's primary source of energy. Blood glucose levels are a key component of routine <strong>Blood Chemistry</strong> tests and are fundamental for assessing metabolic health, particularly in relation to diabetes.</p>
    ...
    `,
    relatedBiomarkers: ['Glycated Hemoglobin (HbA1c)', 'Insulin']
},
{
    id: 'Total Protein',
    name: 'Total Protein',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Total Protein is a measurement of the total amount of protein present in the blood serum. It is a common component of a comprehensive <strong>Blood Chemistry</strong> panel and provides a general assessment of nutritional status, liver function, and kidney function.</p>
        ...
        <p>The two main types of protein measured in total protein are <strong>Albumin</strong> and <strong>Globulins</strong>.</p>
        ...
        <h3>Additional Information:</h3>
        <p>The total protein test is usually evaluated in conjunction with its two main components: <strong>Albumin</strong> and <strong>Globulins</strong>. Often, the <strong>Albumin/Globulin (A/G) ratio</strong> is also calculated, which can provide more specific diagnostic clues than total protein alone.</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Albumin', 'globulins']
},
    {
    id: 'Albumin',
    name: 'Albumin',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Albumin is the most abundant protein found in blood plasma, comprising approximately 50-60% of total plasma proteins. It is synthesized exclusively by the liver and is a key component of a routine <strong>Blood Chemistry</strong> panel.</p>
        ...
        <p>An elevated albumin level (hyperalbuminemia) is almost always due to a <strong>relative increase</strong> in its concentration rather than increased production. It typically indicates a reduction in the fluid portion of the blood.</p>
        <ul>
        ...
        <p>Low albumin is often associated with edema (swelling) due to reduced oncotic pressure, which allows fluid to leak out of blood vessels into the interstitial space. It is frequently assessed as part of a <strong>total protein</strong> measurement, and the ratio of <strong>Albumin to Globulin (A/G ratio)</strong> can provide further diagnostic clues about the type of protein imbalance present.</p>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Creatinine is a waste product generated from the normal breakdown of creatine phosphate in muscle tissue. It is freely filtered by the glomeruli in the kidneys and minimally reabsorbed or secreted by the renal tubules. As such, it is a widely used and reliable <strong>Kidney Function Marker</strong>.</p>

        <h3>Role and Function:</h3>
        <p>The concentration of creatinine in the blood directly reflects the <strong>efficiency of glomerular filtration rate (GFR)</strong>, which is the best overall measure of kidney function. A healthy kidney effectively filters creatinine out of the blood. If kidney function declines, creatinine accumulates in the blood, leading to elevated levels.</p>
        ...
        <p>An elevated creatinine level is the primary indicator of <strong>impaired kidney function or kidney damage</strong>. As kidney function declines, the kidneys are less able to filter creatinine efficiently, causing it to build up in the blood.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Creatinine is a very useful kidney function test. However, because its levels are influenced by muscle mass, it is often used to <strong>estimate Glomerular Filtration Rate (eGFR)</strong>. eGFR is calculated using formulas (e.g., CKD-EPI, MDRD) that take into account creatinine levels, age, sex, and sometimes race, providing a more accurate assessment of kidney function than creatinine alone.</p>
        <p>Creatinine is often measured alongside <strong>Blood Urea Nitrogen (BUN)</strong>. The <strong>BUN/Creatinine ratio</strong> can help differentiate between different causes of kidney impairment (pre-renal, renal, post-renal). For example, a high BUN/Creatinine ratio (with normal or slightly elevated creatinine) often indicates dehydration.</p>
...
},
{
    ...
    detailedInfo: `
        ...
        <h3>Additional Information:</h3>
        <p>Urea (BUN) is most useful when interpreted in conjunction with <strong>Creatinine</strong>. The <strong>BUN/Creatinine ratio</strong> is an important diagnostic tool:</p>
        <ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Bilirubin is a yellowish pigment that is a byproduct of the normal breakdown of red blood cells. When red blood cells complete their lifespan, hemoglobin is broken down, and the heme portion is converted into bilirubin. Bilirubin levels are a key component of <strong>Liver Function Tests (LFTs)</strong> and are crucial for assessing liver health and bile duct function.</p>

        <h3>Metabolism of Bilirubin:</h3>
        <ol>
            <li><strong>Indirect (Unconjugated) Bilirubin:</strong> When red blood cells break down, the heme is initially converted into <strong>unconjugated bilirubin</strong> (also called indirect bilirubin). This form is fat-soluble and insoluble in water, so it binds to albumin in the blood for transport to the liver.</li>
            <li><strong>Direct (Conjugated) Bilirubin:</strong> In the liver, unconjugated bilirubin is "conjugated" (joined) with glucuronic acid by an enzyme called UDP-glucuronosyltransferase. This produces <strong>conjugated bilirubin</strong> (also called direct bilirubin), which is water-soluble.</li>
        ...
        <h3>Low Bilirubin:</h3>
        <p>A low bilirubin level is generally <strong>not considered clinically significant</strong> and usually does not indicate a health problem. It is typically a normal finding.</p>
        ...
        <ul>
            ...
            <li><strong>Consider other Liver Function Tests (LFTs):</strong> Bilirubin results are always interpreted in conjunction with other LFTs like <strong>ALT, AST, ALP, and GGT</strong> to provide a comprehensive picture of liver health and to narrow down the differential diagnosis.</li>
    ...
    `,
    relatedBiomarkers: ['Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'Gamma-glutamyl transferase (GGT)']
    },
    {
    id: 'Bilirubin (Direct)',
    name: 'Bilirubin (Total, Direct, Indirect)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Cholesterol and triglycerides are types of lipids (fats) that are essential for various bodily functions, but abnormal levels can significantly increase the risk of cardiovascular disease. They are measured as part of a <strong>Lipid Panel (or Lipid Profile)</strong>.</p>
        ...
        <p>High levels of total cholesterol, LDL cholesterol, and/or triglycerides, and low levels of HDL cholesterol, are collectively known as dyslipidemia or hyperlipidemia. This condition is a major risk factor for <strong>atherosclerosis</strong> (hardening and narrowing of the arteries), leading to <strong>heart attack, stroke, and peripheral artery disease</strong>.</p>
        <ul>
        ...
        <h3>Low HDL:</h3>
        <p>A low HDL cholesterol level, even with normal total cholesterol, is associated with an <strong>increased cardiovascular risk</strong> because it means less "good" cholesterol is available to clear excess cholesterol from the arteries.</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Glycated Hemoglobin (HbA1c)', 'Homocysteine']
},
{
    id: 'HDL Cholesterol',
    name: 'Cholesterol (Total, HDL, LDL, Triglycerides)',
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Alanine Aminotransferase (ALT), also known as Serum Glutamic Pyruvic Transaminase (SGPT), is an enzyme predominantly found in the liver. It is a highly sensitive and relatively specific <strong>Liver Enzyme</strong> used to detect liver cell damage.</p>
        ...
        <p>Because ALT is primarily located in the cytoplasm of hepatocytes, significant amounts are released into the bloodstream when liver cells are damaged or inflamed. Therefore, elevated ALT levels directly indicate <strong>liver cell injury or inflammation</strong>.</p>
        ...
        <p>An elevated ALT level is the most common and specific indicator of <strong>acute or chronic liver cell damage (hepatocellular injury)</strong>. The degree of elevation often correlates with the extent of liver inflammation or necrosis.</p>
        <ul>
        ...
        <h3>Low ALT:</h3>
        <p>A low ALT level is generally <strong>not clinically significant</strong> and usually does not indicate a health problem. It is a normal finding. Extremely low levels are rare and might be seen in very severe, end-stage liver disease where there are few functional liver cells left to produce the enzyme, or in vitamin B6 deficiency (a cofactor for ALT activity), but these are not primary diagnostic indicators.</p>

        <h3>Additional Information:</h3>
        <p>ALT is a crucial component of <strong>Liver Function Tests (LFTs)</strong>. It is frequently evaluated in conjunction with <strong>Aspartate Aminotransferase (AST)</strong>. While both enzymes are elevated in liver damage, ALT is considered more specific to the liver.</p>
        <p>The <strong>AST/ALT ratio</strong> can provide additional diagnostic clues:</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Aspartate Aminotransferase (AST)', 'Gamma-glutamyl transferase (GGT)', 'Alkaline Phosphatase (ALP)']
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Aspartate Aminotransferase (AST), also known as Serum Glutamic Oxaloacetic Transaminase (SGOT), is an enzyme found in various tissues throughout the body, including the <strong>liver, heart, skeletal muscles, kidneys, brain, and red blood cells</strong>. While often included in Liver Function Tests, its presence in multiple organs makes it <strong>less specific for liver damage than ALT</strong>.</p>
        ...
        <p>Like ALT, AST is released into the bloodstream when cells containing it are damaged or inflamed. Therefore, elevated AST levels indicate <strong>cellular injury</strong> in any of the organs where it is present.</p>
        ...
        <ul>
            <li><strong>Liver Damage:</strong>
                <ul>
                    ...
                    <li><strong>Alcoholic Liver Disease:</strong> <strong>AST is often significantly higher than ALT (AST/ALT ratio > 2:1, often >3:1)</strong>, which is a key distinguishing feature.</li>
        ...
        <h3>Low AST:</h3>
        <p>A low AST level is generally <strong>not clinically significant</strong> and usually does not indicate a health problem. It is a normal finding. Extremely low levels are rare and might be seen in very severe, end-stage liver disease (where there are few remaining viable liver cells) or in vitamin B6 deficiency (a cofactor for AST activity), but these are not primary diagnostic indicators.</p>

        <h3>Additional Information:</h3>
        <p>AST is a routine component of <strong>Liver Function Tests (LFTs)</strong>. Its interpretation is most valuable when compared to ALT. The <strong>AST/ALT ratio</strong> is a critical diagnostic tool:</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Alanine Aminotransferase (ALT)', 'Gamma-glutamyl transferase (GGT)', 'Alkaline Phosphatase (ALP)']
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Gamma-Glutamyl Transferase (GGT), also known as Gamma-Glutamyl Transpeptidase, is an enzyme widely distributed in various tissues, but its highest concentrations are found in the <strong>liver, bile ducts, and kidneys</strong>. It is a useful <strong>Liver Enzyme</strong> marker, particularly for detecting bile duct issues and liver damage associated with alcohol or certain drugs.</p>
        ...
        <p>Elevated GGT levels in the blood most commonly indicate <strong>damage to the bile ducts (cholestasis) or liver cell injury</strong>, or can be a marker of <strong>alcohol consumption</strong> or certain drug effects.</p>
        ...
        <h3>Low GGT:</h3>
        <p>A low GGT level is generally <strong>not clinically significant</strong> and usually does not indicate a health problem. It is a normal finding. GGT levels are typically very low in healthy individuals.</p>

        <h3>Additional Information:</h3>
        <p>GGT is a key component of <strong>Liver Function Tests (LFTs)</strong>. Its primary utility lies in its relationship with ALP:</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'Alkaline Phosphatase (ALP)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Alkaline Phosphatase (ALP) is an enzyme found throughout the body, with significant concentrations in the <strong>liver, bone, kidneys, intestines, and placenta (during pregnancy)</strong>. It is often included in a <strong>Liver Function Test (LFT) panel</strong> but also serves as an important <strong>Bone Marker</strong>.</p>
        ...
        <ul>
            <li><strong>If GGT is also elevated:</strong> The elevated ALP is almost certainly due to <strong>liver or bile duct disease (cholestasis)</strong>.</li>
            <li><strong>If GGT is normal:</strong> The elevated ALP is likely coming from <strong>bone</strong> (or possibly placenta, intestine in specific contexts).</li>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Amylase is a digestive enzyme primarily produced by the <strong>pancreas</strong> and the <strong>salivary glands</strong>. Smaller amounts are also made by the ovaries, fallopian tubes, and small intestine. It is a key <strong>Pancreatic Enzyme</strong> often measured to diagnose conditions affecting these organs.</p>

        <h3>Role and Function:</h3>
        <p>Amylase's main function is to <strong>break down complex carbohydrates (starches) into simpler sugars</strong> (maltose and glucose) in the digestive tract. This process begins in the mouth (salivary amylase) and continues in the small intestine (pancreatic amylase).</p>
        ...
        <p>An elevated amylase level strongly suggests <strong>pancreatitis (inflammation of the pancreas)</strong>, but because amylase is also produced elsewhere, other conditions can cause its elevation. Levels are typically 3-4 times the upper limit of normal or higher in acute pancreatitis.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>While amylase is a useful indicator for pancreatitis, its lack of specificity (due to production by salivary glands and renal clearance) means it is often interpreted in conjunction with <strong>Lipase</strong>.</p>
        <ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lipase is a digestive enzyme that is predominantly produced by the <strong>pancreas</strong>. Smaller amounts are also made in the mouth and stomach. It is considered a highly specific <strong>Pancreatic Enzyme</strong> marker, particularly for the diagnosis of acute pancreatitis.</p>

        <h3>Role and Function:</h3>
        <p>Lipase's primary function is to <strong>break down dietary fats (triglycerides) into smaller fatty acids and glycerol</strong> in the small intestine, facilitating their absorption. This is a critical step in fat digestion.</p>
        <p>In a healthy state, only very low levels of lipase are present in the blood. When the pancreas is inflamed or damaged, lipase leaks into the bloodstream, leading to elevated levels. Because the pancreas is the main source of lipase that enters the bloodstream, elevated serum lipase is a <strong>more specific indicator of pancreatic injury than amylase</strong>.</p>
        ...
        <p>A significantly elevated lipase level is a <strong>highly specific indicator of acute pancreatitis</strong>. Levels are typically 3-5 times the upper limit of normal or higher in acute pancreatitis. Lipase generally remains elevated for a longer period than amylase in acute pancreatitis, making it useful for diagnosis even if a patient presents a few days after symptom onset.</p>
        <ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Sodium (Na$^+$) is the most abundant cation (positively charged ion) in the extracellular fluid (fluid outside cells), including blood plasma. It is a critical <strong>Electrolyte</strong> and its concentration is tightly regulated by the body to maintain fluid balance and proper cellular function.</p>
        ...
        <p>Hypernatremia occurs when serum sodium concentration is above the normal range (&gt;145 mmol/L). It almost always indicates a <strong>deficit of total body water relative to total body sodium</strong>, meaning the body has lost too much water or not taken in enough. The underlying problem is typically water imbalance rather than excess sodium intake.</p>
        <ul>
        ...
        <p>Hyponatremia occurs when serum sodium concentration is below the normal range (&lt;135 mmol/L). It usually indicates an <strong>excess of total body water relative to total body sodium</strong>, rather than an absolute sodium deficiency. The body has too much water, diluting the sodium.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Sodium is a fundamental electrolyte, and its balance is critical for life. Sodium levels are routinely measured as part of an <strong>electrolyte panel</strong> along with potassium and chloride. These measurements help assess fluid balance, kidney function, and the body's acid-base status.</p>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Potassium (K$^+$) is the primary cation (positively charged ion) found inside cells (intracellular fluid). Although only a small amount is in the extracellular fluid (blood plasma), its precise concentration in the blood is crucial for various physiological processes. It is a critical <strong>Electrolyte</strong> routinely measured as part of an electrolyte panel.</p>
        ...
        <ul>
            ...
            <li><strong>Muscle Contraction:</strong> Critical for the contraction of skeletal muscles, smooth muscles (e.g., in the gut), and especially the <strong>heart muscle</strong>. Abnormal potassium levels can lead to life-threatening heart arrhythmias.</li>
        ...
        <p>Hyperkalemia occurs when serum potassium concentration is above the normal range (&gt;5.0 mmol/L). It is a potentially dangerous condition, particularly because it can lead to <strong>life-threatening cardiac arrhythmias and cardiac arrest</strong>.</p>
        <ul>
        ...
        <p>Hypokalemia occurs when serum potassium concentration is below the normal range (&lt;3.5 mmol/L). It can lead to a variety of symptoms, including muscle weakness, cramps, and potentially <strong>dangerous heart arrhythmias</strong>.</p>
        <ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Chloride is the most abundant anion (negatively charged ion) in the extracellular fluid. It is crucial for maintaining the body's fluid balance and acid-base balance. It is routinely measured as part of an <strong>Electrolyte</strong> panel, along with sodium and potassium.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Chloride is typically evaluated as part of an <strong>electrolyte panel</strong> to assess overall fluid and electrolyte balance and acid-base status. It is particularly important for calculating the <strong>Anion Gap</strong>, which is a valuable tool in differentiating causes of metabolic acidosis.</p>
    ...
    detailedInfo: `
        ...
        <p>Both <strong>Total Calcium</strong> and <strong>Ionized Calcium</strong> are important <strong>Mineral</strong> markers, though ionized calcium is a more accurate reflection of the body's functional calcium status, especially when albumin levels are abnormal.</p>
        ...
        <h3>Additional Information:</h3>
        <p>When assessing calcium levels, it's crucial to consider <strong>albumin levels</strong> and the <strong>ionized calcium</strong> measurement for accuracy. Total calcium alone can be misleading if albumin is abnormal.</p>
    ...
    `,
    relatedBiomarkers: ['Phosphorus (Phosphate)', 'Parathyroid Hormone (PTH)', '25-OH Vitamin D (Calcidiol)']
},
{
    id: 'Calcium (Ionized)',
    name: 'Calcium (Total, Ionized)',
...
},
{
    ...
    detailedInfo: `
        ...
        <h3>Additional Information:</h3>
        <p>Phosphorus levels are often interpreted in conjunction with <strong>calcium, PTH, and Vitamin D</strong> levels, as these elements are intricately linked in regulating bone health and mineral metabolism. The <strong>calcium-phosphate product</strong> is also calculated, which is important for assessing the risk of soft tissue and vascular calcification, particularly in chronic kidney disease.</p>
    ...
    `,
    relatedBiomarkers: ['Calcium (Total)', 'Parathyroid Hormone (PTH)', '25-OH Vitamin D (Calcidiol)']
},
{
    id: 'Magnesium',
    name: 'Magnesium',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Magnesium (Mg$^{2+}$) is an essential mineral and electrolyte, the fourth most abundant cation in the body. Approximately 50-60% of magnesium is found in bones, while the rest is in soft tissues (muscles, nerves) and only about 1% is in the blood. It is a vital <strong>Mineral</strong> for numerous biochemical reactions.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Magnesium is essential for overall health, particularly for cardiovascular and neurological function. It is often measured as part of an <strong>electrolyte panel</strong>. Because magnesium imbalance can lead to other electrolyte disturbances (especially potassium and calcium), it is crucial to check and correct magnesium levels when dealing with refractory hypokalemia or hypocalcemia.</p>
    ...
    `,
    relatedBiomarkers: ['Calcium (Total)', 'Potassium']
},
{
    id: 'Uric Acid',
    name: 'Uric Acid',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Uric acid is the final product of <strong>purine metabolism</strong> in humans. Purines are nitrogen-containing compounds found in many foods and are also synthesized by the body as components of DNA and RNA. Uric acid is primarily excreted by the kidneys (about 70%) and to a lesser extent by the intestines. It is a common component of routine <strong>Blood Chemistry</strong> tests.</p>

        <h3>Role and Function:</h3>
        <p>While uric acid is largely a waste product, it does act as a potent <strong>antioxidant</strong> in the blood, protecting against oxidative damage. However, its primary clinical significance lies in its potential to form crystals if present in high concentrations, leading to various health issues.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Uric acid levels are primarily monitored for the diagnosis and management of <strong>gout</strong> and to assess the risk of <strong>uric acid kidney stones</strong>. It is also considered a potential cardiovascular risk factor in some contexts, though its direct causal role is debated.</p>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Creatine Kinase (CK), also known as Creatine Phosphokinase (CPK), is an enzyme primarily found in cells of highly metabolically active tissues, particularly <strong>skeletal muscle, cardiac (heart) muscle, and brain tissue</strong>. When these cells are damaged, CK leaks into the bloodstream. There are different isoforms (isoenzymes) of CK:</p>
        <ul>
        ...
        <p>The total CK level measures all isoforms, while CK-MB specifically measures the cardiac isoform, making them important <strong>Enzyme Markers</strong> for muscle damage and cardiac injury.</p>
        ...
        <p>When muscle cells (skeletal or cardiac) are injured, their cell membranes become permeable, allowing CK to leak into the circulating blood. Therefore, elevated CK levels indicate <strong>muscle damage or necrosis</strong>.</p>
        ...
        <p>An elevated CK-MB, especially when it is also a significant percentage of the total CK (&gt;4%), is a strong indicator of <strong>myocardial injury (damage to the heart muscle)</strong>. It is most commonly used in the diagnosis of <strong>acute myocardial infarction (heart attack)</strong>.</p>
        <ul>
        ...
        <p><em>Note: While CK-MB was historically a primary cardiac marker, <strong>Troponins (Cardiac Troponin I and T)</strong> are now the preferred and more sensitive/specific biomarkers for myocardial infarction. However, CK-MB can still be useful in specific situations, such as detecting reinfarction (a second heart attack) shortly after the first, because CK-MB levels return to normal faster than troponins.</em></p>

        <h3>Low CK:</h3>
        <p>A low CK level is generally <strong>not clinically significant</strong> and usually does not indicate a health problem. It is typically a normal finding.</p>
        ...
        <p>In the context of chest pain, the combination of <strong>CK-MB and Troponins</strong> is often used. Troponins are more sensitive and specific for cardiac damage and remain elevated longer, making them ideal for initial diagnosis. CK-MB can be helpful for assessing the timing of injury or reinfarction.</p>
    `,
    relatedBiomarkers: ['Troponin T']
},
{
    id: 'Creatine Kinase-MB (CK-MB)',
    name: 'Creatine Kinase (CK, CK-MB)',
    description: 'An enzyme found in muscle cells. Elevated levels indicate muscle damage, including heart muscle (CK-MB).',
    type: 'Enzyme Marker',
    responsibleFor: 'Energy production in muscle cells. CK-MB is specific to cardiac muscle.',
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lactate Dehydrogenase (LDH), also known as Lactic Acid Dehydrogenase, is an intracellular enzyme found in the cytoplasm of almost all body cells. It is particularly abundant in the <strong>heart, liver, kidneys, skeletal muscles, red blood cells, brain, and lungs</strong>. Due to its widespread presence, LDH is a <strong>non-specific Enzyme Marker</strong> for cellular damage or tissue injury.</p>
        ...
        <p>When cells are damaged or destroyed, their cellular contents, including LDH, leak into the bloodstream, leading to elevated serum LDH levels. Because it's found in so many tissues, an elevated LDH indicates general <strong>tissue damage or cell destruction</strong>, but not its specific location without further tests.</p>
        ...
        <p><em>Note: It is crucial to check for <strong>hemolysis</strong> (red blood cell breakdown) in the blood sample, as this is a very common cause of falsely elevated LDH in laboratory specimens.</em></p>

        <h3>Low LDH:</h3>
        <p>A low LDH level is generally <strong>not clinically significant</strong> and usually does not indicate a health problem. It is typically a normal finding.</p>
    ...
    `,
    relatedBiomarkers: ['Creatine Kinase (CK, CK-MB)']
    },
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Thyroid Stimulating Hormone (TSH), also known as thyrotropin, is a hormone produced by the <strong>pituitary gland</strong> in the brain. It is the primary regulator of thyroid gland function and is considered the <strong>single best initial test</strong> for evaluating overall thyroid status.</p>

        <h3>Role and Function:</h3>
        <p>TSH's main function is to <strong>stimulate the thyroid gland</strong> (located in the neck) to produce and release thyroid hormones, primarily <strong>Thyroxine (T4)</strong> and to a lesser extent <strong>Triiodothyronine (T3)</strong>.</p>
       </p>
        ...
        <p>A high TSH level indicates that the pituitary gland is working harder than normal to stimulate the thyroid, suggesting an <strong>underactive thyroid gland (hypothyroidism)</strong>. This is usually due to a primary problem with the thyroid gland itself (primary hypothyroidism).</p>
        <ul>
        ...
        <p>A low TSH level indicates that the pituitary gland is producing less TSH, usually because the thyroid gland is overactive or because of external factors suppressing TSH production. This suggests <strong>hyperthyroidism</strong> or TSH suppression.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>TSH is often the <strong>first-line test</strong> for thyroid disorders. If TSH is abnormal, further tests like <strong>Free T4</strong> and <strong>Free T3</strong> are usually performed to confirm the diagnosis and identify the specific type of thyroid dysfunction.</p>
        <ul>
    ...
    `,
    relatedBiomarkers: ['Total T3', 'Free T3', 'Total T4', 'Free T4']
},
{
    id: 'Total T3', 
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Triiodothyronine (T3) is one of the two main hormones produced by the thyroid gland. It is the <strong>metabolically active form</strong> of thyroid hormone, responsible for most of the effects of thyroid hormones on body tissues. <strong>Total T3</strong> measures both the T3 that is bound to proteins in the blood and the unbound, "free" T3.</p>
        ...
        <p>An elevated Total T3 level is a strong indicator of <strong>hyperthyroidism (overactive thyroid)</strong>. In some cases, only T3 levels are elevated, a condition known as T3 toxicosis.</p>
        <ul>
        ...
        <p>A low Total T3 level can indicate <strong>hypothyroidism (underactive thyroid)</strong> or, more commonly, <strong>non-thyroidal illness (euthyroid sick syndrome)</strong>.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>While Total T3 provides an overall picture, its levels can be influenced by changes in protein binding, which may not reflect the actual amount of active hormone. For this reason, <strong>Free T3</strong> (which measures only the unbound, active form) is often considered a more accurate indicator of thyroid function.</p>
        <p>Total T3 is typically ordered along with <strong>TSH and Total T4 (and often Free T4/Free T3)<strong> to provide a comprehensive assessment of thyroid function.</p>
...
},
{
    ...
    detailedInfo: `
        ...
        <p>An elevated Free T3 level is a direct indicator of <strong>hyperthyroidism (overactive thyroid gland)</strong>, meaning the body has too much active thyroid hormone circulating. It is often elevated alongside Free T4 and a suppressed TSH.</p>
        <ul>
        ...
        <p>A low Free T3 level can indicate <strong>hypothyroidism (underactive thyroid)</strong> or, more commonly, <strong>non-thyroidal illness (euthyroid sick syndrome)</strong>.</p>
        <ul>
        ...
        <p>Free T3 is typically evaluated in conjunction with <strong>TSH and Free T4</strong> to provide a complete picture of thyroid function and aid in diagnosis and monitoring of thyroid disorders.</p>
    `,
    relatedBiomarkers: ['TSH', 'Total T3']
},
{
    id: 'Total T4',  
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Thyroxine (T4) is the primary hormone produced and secreted by the thyroid gland. <strong>Total T4</strong> measures the entire amount of T4 in the blood, which includes both the T4 bound to proteins and the small fraction of unbound, "free" T4. It is a fundamental <strong>Thyroid Hormone</strong> marker.</p>

        <h3>Role and Function:</h3>
        <p>T4 is the main secretory product of the thyroid gland, accounting for about 80% of the hormones released. While T4 itself has some metabolic activity, its primary role is as a <strong>prohormone</strong>. In peripheral tissues (like the liver and kidneys), T4 is converted into the more active Triiodothyronine (T3) by deiodinase enzymes.</p>
        ...
        <p>An elevated Total T4 level can indicate <strong>hyperthyroidism (an overactive thyroid gland)</strong>, or it can be due to an increase in the binding proteins that carry T4 in the blood, without true hyperthyroidism.</p>
        <ul>
            <li><strong>Hyperthyroidism:</strong>
                <ul>
                    <li><strong>Graves' Disease:</strong> The most common cause.</li>
        ...
        <p>A low Total T4 level can indicate <strong>hypothyroidism (an underactive thyroid gland)</strong>, or it can be due to a decrease in the binding proteins, without true hypothyroidism, or severe non-thyroidal illness.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>While Total T4 provides a general overview, its interpretation can be complicated by factors affecting thyroid hormone binding proteins. Therefore, <strong>Free T4</strong> (which measures only the unbound, active form) is often a more accurate indicator of thyroid function and is widely preferred for initial assessment and monitoring.</p>
        <p>Total T4 is typically evaluated in conjunction with <strong>TSH and Free T4 (and often Total T3/Free T3)</strong> to provide a comprehensive assessment of thyroid function and aid in diagnosis and management of thyroid disorders.</p>
    `,
    relatedBiomarkers: ['TSH', 'Free T4']
},
{
    id: 'Free T4',
    ...
    detailedInfo: `
        ...
        <p>An elevated Free T4 level indicates <strong>hyperthyroidism (an overactive thyroid gland)</strong>, meaning the thyroid is producing too much active T4. This is typically accompanied by a suppressed TSH level.</p>
        <ul>
            <li><strong>Graves' Disease:</strong> The most common cause of hyperthyroidism.</li>
            <li><strong>Toxic Multinodular Goiter or Toxic Adenoma.</strong></li>
            <li><strong>Thyroiditis (early phase):</strong> Inflammation leading to uncontrolled hormone release.</li>
        ...
        <p>A low Free T4 level indicates <strong>hypothyroidism (an underactive thyroid gland)</strong>, meaning the thyroid is not producing enough active T4. This is typically accompanied by a high TSH level (in primary hypothyroidism).</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Free T4 is considered one of the most reliable and clinically useful thyroid function tests, alongside TSH. It is typically the <strong>second-line test</strong> performed after TSH to confirm a diagnosis of hyperthyroidism or hypothyroidism.</p>
        <ul>
            <li><strong>High TSH with Low Free T4:</strong> Confirms primary hypothyroidism.</li>
    ...
    `,
    relatedBiomarkers: ['TSH', 'Total T4']
    },
    {
    id: 'Cortisol',
    name: 'Cortisol',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Cortisol is a <strong>glucocorticoid hormone</strong> produced by the adrenal glands, which are located on top of the kidneys. It is often referred to as the "stress hormone" because its levels typically rise in response to physical or psychological stress. Cortisol is an essential <strong>Adrenal Hormone</strong> that plays a wide range of roles in the body.</p>
        ...
        <ul>
            ...
            <li><strong>Sleep-Wake Cycle (Diurnal Rhythm):</strong> Cortisol levels naturally fluctuate throughout the day, following a diurnal rhythm:
                <ul>
                    <li><strong>Highest:</strong> Typically in the early morning (around 8 AM).</li>
                    <li><strong>Lowest:</strong> In the late evening or around midnight.</li>
                </ul>
        ...
        <p>Chronically elevated cortisol levels lead to <strong>Cushing's syndrome</strong>. The cause can be endogenous (from within the body) or exogenous (from outside, like medication).</p>
        <ul>
        ...
        <p>Chronically low cortisol levels lead to <strong>adrenal insufficiency</strong>.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Cortisol testing requires careful interpretation due to its diurnal variation and the influence of stress and medications. Often, multiple samples at different times of the day (e.g., morning and midnight) are collected, or dynamic tests like the <strong>ACTH stimulation test</strong> or <strong>dexamethasone suppression test</strong> are performed to assess adrenal function. Urinary free cortisol and salivary cortisol measurements are also used to assess overall daily cortisol production.</p>
        <p>Cortisol is always interpreted in conjunction with <strong>ACTH</strong> to determine the underlying cause of adrenal dysfunction (primary vs. secondary/tertiary).</p>
    `,
    relatedBiomarkers: ['Adrenocorticotropic Hormone (ACTH)']
},
{
    id: 'Adrenocorticotropic hormone (ACTH)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Adrenocorticotropic Hormone (ACTH), also known as corticotropin, is a <strong>polypeptide hormone</strong> produced by the anterior lobe of the <strong>pituitary gland</strong> in the brain. It is the primary regulator of cortisol production by the adrenal glands. ACTH is a crucial <strong>Pituitary Hormone</strong> in the hypothalamic-pituitary-adrenal (HPA) axis.</p>

        <h3>Role and Function:</h3>
        <p>ACTH's main function is to <strong>stimulate the adrenal cortex</strong> (the outer part of the adrenal glands) to produce and release <strong>cortisol</strong>. It also has a minor role in stimulating the production of adrenal androgens and aldosterone.</p>
        ...
        <p>Like cortisol, ACTH levels also exhibit a <strong>diurnal rhythm</strong>, typically highest in the early morning and lowest in the late evening/midnight.</p>
        ...
        <h3>Additional Information:</h3>
        <p>ACTH levels are almost always measured in conjunction with <strong>Cortisol</strong> to help differentiate between primary, secondary, and tertiary adrenal disorders. The pattern of ACTH and cortisol results is crucial for diagnosis:</p>
        <ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Testosterone is the principal <strong>androgen</strong> (male sex hormone) in males, primarily produced by the Leydig cells in the testes. It is also produced in smaller amounts by the adrenal glands in both sexes, and by the ovaries in females. It is a crucial <strong>Sex Hormone</strong> involved in various physiological processes in both males and females.</p>
        ...
        <h3>Additional Information:</h3>
        <p>When evaluating testosterone levels, it's important to consider factors like the time of day the sample was taken (for males, morning is best), age, and the patient's symptoms. Often, <strong>Free Testosterone</strong> or <strong>Bioavailable Testosterone</strong> (which accounts for SHBG levels) is measured in addition to Total Testosterone for a more accurate assessment, especially if SHBG levels are suspected to be abnormal (e.g., due to liver disease, thyroid disease, or obesity).</p>
        <p>Testosterone levels are typically interpreted in conjunction with <strong>LH and FSH</strong> to differentiate between primary and secondary hypogonadism. <strong>Estradiol</strong> levels may also be relevant, especially in males with symptoms of estrogen excess or females with hormonal imbalances.</p>
    `,
    relatedBiomarkers: ['Estradiol', 'Follicle-Stimulating Hormone (FSH)', 'Luteinizing hormone (LH)']
},
{
    id: 'Estradiol',
    name: 'Estradiol (E2)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Estradiol (E2) is the most potent and abundant form of estrogen produced during a woman's reproductive years. It is primarily synthesized in the ovaries, but also in smaller amounts by the adrenal glands, testes (in males), and other tissues (e.g., fat, brain). It is a key <strong>Sex Hormone</strong> involved in a wide range of physiological processes.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Estradiol is a key marker in evaluating <strong>female reproductive health</strong>, including fertility, menstrual irregularities, and menopausal status. It is often measured in conjunction with <strong>FSH, LH, and Progesterone</strong> to assess ovarian function and diagnose hormonal imbalances.</p>
    ...
    `,
    relatedBiomarkers: ['progesterone', 'Follicle-Stimulating Hormone (FSH)', 'Luteinizing hormone (LH)']
},
{
    id: 'Progesterone',
    name: 'Progesterone',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Progesterone is a crucial <strong>steroid hormone</strong> primarily produced by the <strong>corpus luteum</strong> (a temporary structure formed in the ovary after ovulation) in females. Smaller amounts are produced by the adrenal glands in both sexes and by the placenta during pregnancy. It is a key <strong>Sex Hormone</strong> essential for female reproductive processes.</p>
        ...
        <p>Progesterone levels are tightly regulated by <strong>LH</strong> from the pituitary gland, particularly after ovulation.</p>
        ...
        <ul>
            <li><strong>Confirming Ovulation:</strong> A mid-luteal phase (typically 7 days after presumed ovulation or 21 days into a 28-day cycle) progesterone level above 16 nmol/L (5 ng/mL) generally confirms that ovulation has occurred.</li>
            <li><strong>Assessing Luteal Phase Adequacy:</strong> Important for fertility investigations.</li>
            <li><strong>Evaluating Early Pregnancy:</strong> To assess viability, differentiate between normal and abnormal pregnancies (e.g., ectopic, miscarriage).</li>
            <li><strong>Monitoring Fertility Treatments.</strong></li>
        </ul>
        <p>Progesterone levels are typically interpreted in conjunction with <strong>Estradiol (E2) and Luteinizing Hormone (LH)</strong> to provide a comprehensive assessment of the menstrual cycle and reproductive function.</p>
    `,
    relatedBiomarkers: ['Estradiol', 'Luteinizing hormone (LH)']
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Follicle-Stimulating Hormone (FSH) is a <strong>gonadotropin hormone<.strong> produced and secreted by the anterior lobe of the <strong>pituitary gland</strong> in the brain. It is one of the key hormones in the regulation of the reproductive system in both males and females. FSH is a crucial <strong>Pituitary Hormone</strong> in the hypothalamic-pituitary-gonadal (HPG) axis.</p>
        ...
        <p>FSH release is regulated by <strong>Gonadotropin-Releasing Hormone (GnRH)</strong> from the hypothalamus and by negative feedback from sex hormones (estrogen, progesterone, testosterone) and inhibin produced by the gonads.</p>
        ...
        <h3>Additional Information:</h3>
        <p>FSH is commonly measured in conjunction with <strong>LH, Estradiol, and Testosterone</strong> to evaluate:</p>
        <ul>
            <li><strong>Female Fertility:</strong> To assess ovarian reserve, diagnose ovulatory disorders, and evaluate for menopause or premature ovarian failure.</li>
            <li><strong>Male Fertility:</strong> To evaluate testicular function and sperm production, and differentiate between primary and secondary hypogonadism.</li>
            <li><strong>Pituitary Function:</strong> To identify central causes of hypogonadism.</li>
            <li><strong>Pubertal Development:</strong> To assess delayed or precocious puberty.</li>
        </ul>
        <p>The <strong>FSH:LH ratio</strong> can also be clinically relevant in some conditions, such as PCOS, where LH may be disproportionately higher than FSH.</p>
    `,
    relatedBiomarkers: ['Luteinizing hormone (LH)', 'Estradiol', 'Testosterone (Total)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Luteinizing Hormone (LH) is a <strong>gonadotropin hormone</strong> produced and secreted by the anterior lobe of the <strong>pituitary gland</strong> in the brain. It is one of the key hormones in the regulation of the reproductive system in both males and females. LH is a crucial <strong>Pituitary Hormone</strong> in the hypothalamic-pituitary-gonadal (HPG) axis.</p>
        ...
        <p>LH release is regulated by <strong>Gonadotropin-Releasing Hormone (GnRH)</strong> from the hypothalamus. Sex hormones (estrogen, progesterone, testosterone) provide negative feedback to the hypothalamus and pituitary, regulating LH secretion. In females, there's also a positive feedback mechanism where rising estrogen triggers the LH surge.</p>
        ...
        <h3>Additional Information:</h3>
        <p>LH is commonly measured in conjunction with <strong>FSH, Estradiol, Progesterone, and Testosterone</strong> to evaluate:</p>
        <ul>
            <li><strong>Female Fertility:</strong> To predict ovulation (LH surge), diagnose ovulatory disorders, and assess ovarian function, particularly in relation to PCOS and menopause.</li>
            <li><strong>Male Fertility:</strong> To evaluate testicular function and testosterone production, and differentiate between primary and secondary hypogonadism.</li>
            <li><strong>Pituitary Function:</strong> To identify central causes of hypogonadism.</li>
            <li><strong>Pubertal Development:</strong> To assess delayed or precocious puberty.</li>
        </ul>
        <p>The <strong>LH:FSH ratio</strong> can be particularly helpful in diagnosing PCOS in some cases.</p>
    `,
    relatedBiomarkers: ['Follicle-Stimulating Hormone (FSH)', 'Estradiol', 'progesterone', 'Testosterone (Total)']
},
{
    id: 'Prolactin', 
    name: 'Prolactin',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Prolactin is a <strong>peptide hormone</strong> primarily produced and secreted by the anterior lobe of the <strong>pituitary gland</strong> in the brain. It is also produced in smaller amounts by other tissues, including the breast, brain, uterus, and immune cells. It is a crucial <strong>Pituitary Hormone</strong> best known for its role in lactation.</p>

        <h3>Role and Function:</h3>
        <p>Prolactin's main function is to <strong>stimulate and maintain milk production (lactation)</strong> in women after childbirth. However, it has over 300 known functions, including roles in:</p>
        <ul>
        ...
        <p>Prolactin secretion is primarily regulated by <strong>dopamine</strong> (which inhibits its release) from the hypothalamus. Other factors, such as TRH (Thyrotropin-Releasing Hormone), VIP, and estrogen, can stimulate prolactin release.</p>
        ...
        <ul>
            ...
            <li><strong>Medications:</strong>
                <ul>
                    ...
                    <li><strong>Certain Antidepressants, Opioids, Estrogens (high doses).</strong></li>
                </ul>
            </li>
        ...
        <h3>Additional Information:</h3>
        <p>When assessing prolactin, it's important to rule out <strong>macroprolactinemia</strong>, a condition where prolactin circulates in a large, inactive form (macroprolactin) that can cause falsely elevated readings on standard assays without clinical symptoms. If hyperprolactinemia is suspected, especially without clear symptoms, further investigation for macroprolactin is often done.</p>
        <p>Prolactin is often measured as part of an infertility workup for both sexes, and when investigating menstrual irregularities, galactorrhea, or symptoms of hypogonadism. It is often interpreted alongside <strong>TSH</strong> (due to the link between hypothyroidism and hyperprolactinemia) and sex hormones (e.g., <strong>estradiol, testosterone, LH, FSH</strong>).</p>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Insulin is a <strong>peptide hormone</strong> produced by the <strong>beta cells of the islets of Langerhans</strong> in the pancreas. It is the primary hormone responsible for lowering blood glucose levels after a meal. Insulin is a critical <strong>Pancreatic Hormone</strong> in glucose homeostasis.</p>
        ...
        <ul>
            <li><strong>Investigating Hypoglycemia:</strong> To determine if low blood sugar is due to excess insulin (e.g., insulinoma) or other causes.</li>
            <li><strong>Assessing Insulin Resistance:</strong> High fasting insulin with normal or elevated glucose suggests insulin resistance.</li>
            <li><strong>Differentiating Diabetes Types:</strong> While not definitive on its own, very low or undetectable insulin levels in a newly diagnosed diabetic typically point to Type 1 diabetes. However, <strong>C-peptide</strong> is a more reliable marker for this purpose as it is not affected by exogenous insulin administration.</li>
        </ul>
        <p>Insulin is often measured alongside <strong>C-peptide, Glucose, and HbA1c</strong> to provide a comprehensive assessment of glucose metabolism and pancreatic beta cell function.</p>
    `,
    relatedBiomarkers: ['C-peptide', 'glucose', 'Glycated Hemoglobin (HbA1c)']
},
{
    id: 'C-peptide',
    name: 'C-peptide',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>C-peptide (connecting peptide) is a <strong>short protein</strong> that is produced in the pancreas and released into the bloodstream in equal molar amounts with insulin when the proinsulin molecule is cleaved to form insulin. Unlike insulin, C-peptide is not significantly removed by the liver, giving it a longer half-life and more stable blood levels. This makes it an excellent and reliable indicator of the <strong>body's own (endogenous) insulin production</strong>.</p>
        <p>It is a crucial <strong>Pancreatic Hormone</strong>-related biomarker for assessing beta-cell function.</p>

        <h3>Role and Function:</h3>
        <p>The primary role of C-peptide measurement in diagnostics is to serve as a <strong>marker of endogenous insulin secretion</strong>. When the pancreatic beta cells produce insulin, they first synthesize proinsulin. Proinsulin is then cleaved into two parts: active insulin and C-peptide. Both are released into the portal circulation.</p>
        <ul>
        ...
        <ul>
            <li><strong>Insulin Resistance:</strong> The most common cause. In conditions like <strong>Type 2 Diabetes (especially in early stages), obesity, or Polycystic Ovary Syndrome (PCOS)</strong>, cells are resistant to insulin's effects, so the pancreas compensates by producing more insulin, and thus more C-peptide.</li>
        ...
        <ul>
            <li><strong>Differentiating Type 1 from Type 2 Diabetes:</strong> Low C-peptide strongly suggests Type 1, while normal to high C-peptide suggests Type 2 (or insulin resistance).</li>
            <li><strong>Assessing Residual Beta Cell Function:</strong> In established diabetes, it can help determine if the patient's pancreas still produces some insulin, which can influence treatment decisions (e.g., need for insulin therapy).</li>
            <li><strong>Investigating Hypoglycemia:</strong> To determine if low blood sugar is due to endogenous insulin overproduction (high C-peptide, e.g., insulinoma) or exogenous insulin overdose (low C-peptide).</li>
            <li><strong>Monitoring Pancreas Transplants.</strong></li>
        </ul>
        <p>C-peptide is often measured alongside <strong>Insulin, Glucose, and HbA1c</strong> for a comprehensive evaluation of glucose metabolism and pancreatic function.</p>
    `,
    relatedBiomarkers: ['Insulin', 'glucose']
},
{
    id: 'Parathyroid hormone (PTH)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Parathyroid Hormone (PTH), also known as parathormone, is a <strong>peptide hormone</strong> produced by the <strong>parathyroid glands</strong>, four small glands located in the neck, usually behind the thyroid gland. PTH is the primary regulator of calcium and phosphate metabolism in the body. It is a crucial <strong>Parathyroid Hormone</strong> marker.</p>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>C-Reactive Protein (CRP) is an <strong>acute phase reactant</strong> protein produced by the liver. Its production rapidly increases in response to inflammation, infection, and tissue injury. CRP is a widely used <strong>Inflammation Marker</strong>.</p>
        ...
        <h3>Additional Information:</h3>
        <p>CRP is a <strong>non-specific</strong> marker, meaning it indicates inflammation but does not tell you the cause or location of the inflammation. It must be interpreted in the context of a patient's clinical symptoms, history, and other diagnostic tests.</p>
        <p>It is particularly useful for:</p>
        <ul>
            <li><strong>Detecting Acute Inflammation/Infection:</strong> A rapid rise suggests an active process.</li>
            <li><strong>Monitoring Disease Activity:</strong> In chronic inflammatory diseases (e.g., RA, IBD), CRP can track treatment effectiveness.</li>
            <li><strong>Assessing Cardiovascular Risk (hs-CRP):</strong> A valuable predictor independent of cholesterol levels.</li>
            <li><strong>Differentiating between bacterial and viral infections:</strong> While not absolute, very high CRP often suggests bacterial.</li>
        </ul>
        <p>CRP is often measured alongside <strong>Erythrocyte Sedimentation Rate (ESR)</strong>, another non-specific inflammation marker, though CRP typically rises and falls more rapidly than ESR. <strong>Procalcitonin (PCT)</strong> can be used to specifically help distinguish bacterial from viral infections.</p>
    `,
    relatedBiomarkers: ['', 'pct']
},
{
    id: 'Procalcitonin (PCT)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Procalcitonin (PCT) is a <strong>prohormone</strong> of calcitonin, a hormone involved in calcium metabolism. Unlike calcitonin, PCT has no known hormonal activity but serves as a crucial <strong>biomarker for systemic bacterial infections and sepsis</strong>. It is produced by the C-cells of the thyroid gland, but during severe systemic bacterial infections, many other cell types throughout the body can produce PCT, leading to a significant increase in its blood levels. It is a critical <strong>Sepsis Marker</strong>.</p>
        ...
        <p>PCT is often used in emergency departments and intensive care units to aid in the diagnosis and management of sepsis. It is typically interpreted along with other clinical signs, symptoms, and lab results like <strong>CRP and White Blood Cell (WBC) count</strong>.</p>
    `,
    relatedBiomarkers: ['C-reactive protein (CRP)', 'White Blood Cell Count (WBC)']
},
{
    id: 'Ferritin',
    name: 'Ferritin',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Ferritin is a <strong>globular protein complex</strong> that plays a crucial role in iron homeostasis by storing iron within cells in a non-toxic form. Small amounts of ferritin circulate in the blood, and the level of <strong>serum ferritin</strong> is directly proportional to the amount of iron stored in the body's tissues. It is considered the most reliable <strong>Iron Storage Marker</strong>.</p>
        ...
        <p>A low ferritin level is the earliest and most sensitive indicator of <strong>iron deficiency</strong> in the body, even before anemia develops.</p>
        <ul>
        ...
        <h3>Additional Information:</h3>
        <p>Due to its role as an acute phase reactant, a high ferritin level alone may not indicate iron overload if inflammation is also present. In such cases, other iron studies like <strong>Transferrin Saturation (TSAT)</strong> and <strong>Serum Iron</strong> are often needed for accurate diagnosis. A low TSAT with a high ferritin might suggest "anemia of chronic disease" rather than iron overload.</p>
        <p>Ferritin is routinely measured when <strong>anemia is suspected</strong>, particularly iron deficiency anemia. It is also used to screen for and monitor iron overload disorders like hemochromatosis. It's often interpreted in conjunction with <strong>Serum Iron, Total Iron Binding Capacity (TIBC), and Transferrin Saturation</strong> for a complete iron panel.</p>
    `,
    relatedBiomarkers: ['Serum Iron', 'Total Iron-Binding Capacity (TIBC)']
    },
    {
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Rheumatoid Factor (RF) is an <strong>autoantibody</strong>, meaning it is an antibody produced by the immune system that mistakenly targets the body's own tissues. Specifically, RF typically targets the Fc portion of human IgG antibodies. It is a key <strong>Autoantibody / Immune Marker</strong> used in the diagnosis and prognosis of rheumatoid arthritis (RA) and other autoimmune conditions.</p>
        ...
        <ul>
            <li><strong>Anti-Citrullinated Protein Antibodies (ACPA) / Anti-CCP Antibodies:</strong> A more specific marker for RA than RF, often present even in RF-negative RA.</li>
            <li><strong>Erythrocyte Sedimentation Rate (ESR)</strong> and <strong>C-Reactive Protein (CRP):</strong> Non-specific markers of inflammation that are often elevated in RA and other inflammatory conditions.</li>
            <li><strong>Other autoantibodies:</strong> Depending on suspected underlying conditions (e.g., ANA for lupus, anti-Ro/La for Sjögren's).</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['C-reactive protein (CRP)', 'Erythrocyte Sedimentation Rate (ESR)', 'anti-ccp-antibodies'] 
},
{
    id: 'Immunoglobulin A (IgA)',
    ...
    detailedInfo: `
        ...
        <ul>
            <li><strong>Immunoglobulin G (IgG):</strong> The most abundant antibody, providing long-term immunity.</li>
            <li><strong>Immunoglobulin M (IgM):</strong> The first antibody produced in response to a new infection.</li>
            <li><strong>Immunoglobulin E (IgE):</strong> Associated with allergies and parasitic infections.</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['Immunoglobulin G (IgG)', 'Immunoglobulin M (IgM)', 'ige', 'anti-tTG-IgA'] // Added IgE and anti-tTG-IgA for relevance to IgA.
},
{
    id: 'Immunoglobulin G (IgG)',
    ...
    detailedInfo: `
        ...
        <p>It is typically interpreted alongside other immunoglobulins:</p>
        <ul>
            <li><strong>Immunoglobulin A (IgA):</strong> Important for mucosal immunity.</li>
            <li><strong>Immunoglobulin M (IgM):</strong> First antibody produced in initial immune response.</li>
            <li><strong>Immunoglobulin E (IgE):</strong> Associated with allergies and parasitic infections.</li>
            <li><strong>Complement C3 and C4:</strong> Components of the complement system, which IgG can activate.</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['Immunoglobulin A (IgA)', 'Immunoglobulin M (IgM)', 'ige', 'complement-c3', 'complement-c4'] // Added IgE and Complement for comprehensive immune panel.
},
{
    id: 'Immunoglobulin M (IgM)',
    ...
    detailedInfo: `
        ...
        <ul>
            <li><strong>Immunoglobulin A (IgA):</strong> Important for mucosal immunity.</li>
            <li><strong>Immunoglobulin G (IgG):</strong> Provides long-term immunity.</li>
            <li><strong>Immunoglobulin E (IgE):</strong> Associated with allergies and parasitic infections.</li>
            <li><strong>Complement C3 and C4:</strong> Components of the complement system, which IgM is a potent activator of.</li>
        </ul>
    ...
    `,
    relatedBiomarkers: ['Immunoglobulin A (IgA)', 'Immunoglobulin G (IgG)', 'ige', 'complement-c3', 'complement-c4'] // Added IgE and Complement for comprehensive immune panel.
},
{
    id: 'ige',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Immunoglobulin E (IgE) is the least abundant antibody in serum but plays a critical role in <strong>Type I hypersensitivity reactions (allergies)</strong> and immune responses to parasites. It is a monomeric antibody produced by plasma cells. IgE is a specialized <strong>Immunoglobulin</strong> involved in allergic and anti-parasitic immunity.</p>
        ...
        <ul>
            <li><strong>Eosinophil Count:</strong> Eosinophils are immune cells often elevated in allergies and parasitic infections.</li>
            <li><strong>Skin Prick Tests:</strong> Direct assessment of allergic sensitization.</li>
            <li><strong>Tryptase:</strong> Released by mast cells during acute allergic reactions.</li>
        </ul>
        <p>While IgE is part of the overall immunoglobulin panel (with <strong>IgA, IgG, IgM</strong>), its clinical utility is often more focused on allergic and parasitic diseases.</p>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Complement C3 is a central protein of the <strong>complement system</strong>, a crucial part of the innate immune system. The complement system consists of a cascade of plasma proteins that, when activated, work together to enhance the body's ability to clear pathogens, remove damaged cells, and regulate inflammation. C3 is the most abundant complement protein and a key <strong>Immune System Component</strong>.</p>
        ...
        <h3>Additional Information:</h3>
        <p>C3 levels are typically measured along with <strong>Complement C4</strong> to assess the overall status of the complement system and to help differentiate between activation pathways. For instance, low C4 and C3 suggest classical pathway activation (common in lupus), while low C3 with normal C4 might suggest alternative pathway activation.</p>
        <p>C3 and C4 are critical for monitoring disease activity and response to treatment in immune complex-mediated diseases like SLE. They are also interpreted in conjunction with other immune markers such as <strong>IgG, IgA, IgM, and ANA (Antinuclear Antibodies)</strong>.</p>
    `,
    relatedBiomarkers: ['complement-c4', 'Immunoglobulin G (IgG)', 'Immunoglobulin A (IgA)', 'Immunoglobulin M (IgM)', 'ana'] // Added immunoglobulins and ANA for comprehensive immune assessment.
},
{
    id: 'complement-c4',
    name: 'Complement C4',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Complement C4 is another significant protein of the <strong>complement system</strong>, a vital part of the innate immune response. C4 is primarily involved in the <strong>classical and lectin pathways</strong> of complement activation. Like C3, it is a key <strong>Immune System Component</strong> that contributes to the elimination of pathogens and the clearance of immune complexes.</p>
        ...
        <h3>Additional Information:</h3>
        <p>C4 levels are almost always measured alongside <strong>Complement C3</strong> to provide a more complete picture of complement system activity. The pattern of C3 and C4 levels can help pinpoint which pathway of the complement system is activated or deficient. For example:</p>
        <ul>
        ...
        <p>C4 is crucial for monitoring disease activity and response to treatment in immune complex-mediated diseases. It is also interpreted in conjunction with other immune markers such as <strong>IgG, IgA, IgM, and ANA (Antinuclear Antibodies)</strong>.</p>
    `,
    relatedBiomarkers: ['complement-c3', 'Immunoglobulin G (IgG)', 'Immunoglobulin A (IgA)', 'Immunoglobulin M (IgM)', 'ana'] // Added immunoglobulins and ANA for comprehensive immune assessment.
},
{
    id: 'Troponin T', 
    name: 'Troponins (T, I)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Troponins (Cardiac Troponin T [cTnT] and Cardiac Troponin I [cTnI]) are <strong>regulatory proteins</strong> found specifically in the muscle cells of the heart. When heart muscle is damaged, these proteins are released into the bloodstream. They are highly sensitive and specific <strong>Cardiac Markers</strong> for myocardial injury.</p>
        ...
        <ul>
            <li><strong>BNP/NT-proBNP:</strong> To assess for heart failure.</li>
            <li><strong>CK-MB:</strong> An older cardiac marker, less specific than troponin but sometimes still used.</li>
            <li><strong>ECG (Electrocardiogram):</strong> To look for electrical changes in the heart.</li>
            <li><strong>Imaging Studies:</strong> (e.g., echocardiogram, cardiac MRI) to assess heart function and structure.</li>
        </ul>
    `,
...
{
    id: 'N-terminal pro-brain natriuretic peptide (NT-proBNP)',
    name: 'BNP/NT-proBNP', 
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Brain Natriuretic Peptide (BNP) and N-terminal pro-B-type Natriuretic Peptide (NT-proBNP) are <strong>neurohormones</strong> primarily produced and secreted by the cardiac ventricles in response to increased wall stress and volume overload, commonly seen in heart failure. They are critical <strong>Cardiac Markers</strong> used for the diagnosis, prognosis, and management of heart failure.</p>
        ...
        <ul>
            <li><strong>Troponins:</strong> To assess for myocardial injury (heart attack).</li>
            <li><strong>Echocardiogram:</strong> Imaging to assess heart structure and function (ejection fraction).</li>
            <li><strong>ECG (Electrocardiogram):</strong> To look for electrical abnormalities.</li>
            <li><strong>Chest X-ray:</strong> To assess for fluid in the lungs (pulmonary edema).</li>
        </ul>
        <p>Interpreting BNP/NT-proBNP requires consideration of age, kidney function, and other co-existing medical conditions.</p>
    `,
    relatedBiomarkers: ['Troponin T', 'echocardiogram'] // Added echocardiogram as it's directly related to heart function assessment.
},
{
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Homocysteine is a <strong>sulfur-containing amino acid</strong> that is an intermediate product in the metabolism of methionine, an essential amino acid. It is not incorporated into proteins. Elevated levels of homocysteine in the blood are recognized as an independent <strong>Cardiovascular Risk Marker</strong>.</p>
        ...
        <p>Monitoring homocysteine levels can help guide supplementation with <strong>Folate, Vitamin B12, and Vitamin B6</strong> to lower levels and potentially reduce cardiovascular risk, although the clinical benefits of such supplementation for reducing cardiovascular events are still debated and require further research.</p>
        <p>It is interpreted in the context of other cardiovascular risk factors like <strong>Cholesterol (LDL, HDL), Triglycerides, and hs-CRP</strong>.</p>
    `,
    relatedBiomarkers: ['Total Cholesterol', 'Vitamin B12 (Cobalamin)', 'Folic Acid (Folate)', 'vitamin-b6', 'hs-crp'] // Added Vitamin B6 and hs-CRP.
},
{
    id: 'Lipoprotein (a) - Lp(a)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lipoprotein(a) [Lp(a)] is a unique and complex <strong>lipoprotein</strong> particle structurally similar to low-density lipoprotein (LDL) but with an additional protein called apolipoprotein(a) [apo(a)] covalently attached to apoB-100. Levels of Lp(a) in the blood are largely <strong>genetically determined</strong> and remain relatively stable throughout an individual's life. It is recognized as an independent <strong>Cardiovascular Risk Marker</strong>.</p>
        ...
        <ul>
            <li><strong>Family history of premature cardiovascular disease.</strong></li>
            <li><strong>Personal history of ASCVD despite optimal traditional risk factors.</strong></li>
            <li><strong>Recurrent cardiovascular events despite aggressive therapy.</strong></li>
            <li><strong>Familial hypercholesterolemia.</strong></li>
        </ul>
        <p>Management of elevated Lp(a) often focuses on aggressive control of other traditional cardiovascular risk factors (LDL-C, hypertension, diabetes) and, increasingly, newer medications specifically targeting Lp(a) are being developed. Lp(a) is considered alongside overall <strong>Cholesterol Panel (Total Cholesterol, LDL-C, HDL-C, Triglycerides)</strong> to assess comprehensive lipid risk.</p>
    `,
    relatedBiomarkers: ['Total Cholesterol', 'ldl-cholesterol', 'hdl-cholesterol', 'triglycerides'] // Explicitly listed components of a lipid panel.
},
{
    id: 'PSA (Total)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Prostate-Specific Antigen (PSA) is a <strong>glycoprotein</strong> produced almost exclusively by the epithelial cells of the prostate gland. It functions as a serine protease that helps to liquefy seminal fluid. PSA is the most widely used <strong>Tumor Marker</strong> for prostate cancer screening, diagnosis, and monitoring.</p>
        <p>PSA exists in two main forms in the blood: <strong>Total PSA</strong> (the sum of free and bound PSA) and <strong>Free PSA</strong> (unbound PSA).</p>
        ...
        <p>The <strong>Free PSA to Total PSA ratio</strong> helps differentiate between benign prostate conditions and prostate cancer, especially when the total PSA is in the "grey zone" (e.g., 4-10 ng/mL).</p>
        ...
        <ul>
            <li><strong>Prostate Health Index (PHI):</strong> Combines total PSA, free PSA, and a third form of PSA ([-2]proPSA) to improve prostate cancer detection.</li>
            <li><strong>4Kscore Test:</strong> Combines total PSA, free PSA, intact PSA, and human kallikrein 2 (hK2) with clinical factors to predict the risk of high-grade prostate cancer.</li>
            <li><strong>Prostate Cancer Antigen 3 (PCA3):</strong> A non-coding RNA marker found in urine after DRE, more specific for prostate cancer than PSA.</li>
            <li><strong>MRI of the Prostate:</strong> Used to visualize suspicious areas for targeted biopsy.</li>
        </ul>
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>CA-125 (Cancer Antigen 125 or Carbohydrate Antigen 125) is a <strong>glycoprotein</strong> found on the surface of many ovarian cancer cells and, to a lesser extent, on other normal and cancerous cells. It is released into the bloodstream and can be measured as a <strong>Tumor Marker</strong>, primarily used in the management of ovarian cancer.</p>
        ...
        <ul>
            <li><strong>HE4 (Human Epididymis Protein 4):</strong> Often elevated in ovarian cancer and has higher specificity than CA-125 in differentiating benign from malignant pelvic masses. It is a key component of the ROMA algorithm.</li>
            <li><strong>ROMA (Risk of Ovarian Malignancy Algorithm):</strong> An algorithm that combines CA-125, HE4, and menopausal status to calculate a score indicating the risk of ovarian cancer.</li>
            <li><strong>Ultrasound or other imaging studies:</strong> Essential for evaluating pelvic masses.</li>
        </ul>
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Carcinoembryonic Antigen (CEA) is a <strong>glycoprotein</strong> normally produced during fetal development. Production usually stops before birth. In adults, elevated levels of CEA can be associated with various types of cancer, particularly <strong>colorectal cancer</strong>, and also with some non-cancerous conditions. It is primarily used as a <strong>Tumor Marker</strong> for monitoring, rather than screening.</p>
        ...
        <ul>
            <li><strong>CA 19-9:</strong> For pancreatic and gastric cancers.</li>
            <li><strong>CA 125:</strong> For ovarian cancer.</li>
            <li><strong>CA 15-3:</strong> For breast cancer.</li>
            <li><strong>AFP (Alpha-Fetoprotein):</strong> For liver and germ cell tumors.</li>
            <li><strong>Imaging Studies:</strong> (e.g., CT scans, MRI, PET scans) are essential for staging and detecting recurrence.</li>
            <li><strong>Biopsy:</strong> Definitive diagnosis of cancer.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Alpha-Fetoprotein (AFP) is a <strong>glycoprotein</strong> that is normally produced in large quantities by the fetal liver and yolk sac during embryonic development. Its levels significantly decrease after birth. In adults, elevated AFP levels are typically associated with certain types of cancer or severe liver disease. It serves a dual role as a <strong>Tumor Marker</strong> and a <strong>Prenatal Marker</strong>.</p>
        ...
        <ul>
            <li><strong>hCG (Human Chorionic Gonadotropin):</strong> Often elevated with AFP in germ cell tumors; also a key marker in prenatal screening.</li>
            <li><strong>LDH (Lactate Dehydrogenase):</strong> Another marker that can be elevated in germ cell tumors.</li>
            <li><strong>CA 19-9 and CEA:</strong> Other GI-related tumor markers that might be assessed in liver cancer workup.</li>
            <li><strong>Unconjugated Estriol and Inhibin A:</strong> Other components of the prenatal quad screen.</li>
        </ul>
    `,
    relatedBiomarkers: ['HCG', 'Lactate Dehydrogenase (LDH)', 'CA-19-9', 'CEA', 'unconjugated-estriol', 'inhibin-a'] // Added LDH and the other quad screen components.
},
{
    id: 'CA-19-9',
    name: 'CA 19-9',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>CA 19-9 (Carbohydrate Antigen 19-9) is a <strong>glycoprotein</strong> related to the Lewis blood group antigen. It is found on the surface of some cancer cells, particularly those of the gastrointestinal tract, and can be shed into the bloodstream. It is primarily used as a <strong>Tumor Marker</strong> for pancreatic cancer, and also in bile duct and gastric cancers.</p>
        ...
        <ul>
            <li><strong>CEA (Carcinoembryonic Antigen):</strong> Another general tumor marker, sometimes elevated in GI cancers.</li>
            <li><strong>AFP (Alpha-Fetoprotein):</strong> Primary marker for liver cancer.</li>
            <li><strong>Bilirubin, Alkaline Phosphatase, GGT:</strong> Liver function tests often elevated in biliary obstruction.</li>
        </ul>
    `,
    relatedBiomarkers: ['CEA', 'AFP', 'bilirubin', 'alkaline-phosphatase', 'Gamma-glutamyl transferase (GGT)'] // Added liver function tests for relevance to biliary issues.
},
{
    id: 'CA-15-3',
    name: 'CA 15-3',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>CA 15-3 (Cancer Antigen 15-3) is a <strong>mucin-like glycoprotein</strong> (MUC1) expressed on the surface of some cancer cells. It is shed into the bloodstream and serves as a <strong>Tumor Marker</strong>, predominantly used for monitoring patients with <strong>breast cancer</strong>.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>CA 27-29:</strong> Another tumor marker structurally similar to CA 15-3, also used for monitoring breast cancer.</li>
            <li><strong>CEA (Carcinoembryonic Antigen):</strong> Can sometimes be elevated in breast cancer, especially with metastatic disease.</li>
            <li><strong>Estrogen Receptor (ER), Progesterone Receptor (PR), HER2:</strong> Biomarkers from tumor tissue, crucial for guiding breast cancer treatment.</li>
            <li><strong>Imaging Studies:</strong> Such as mammography, ultrasound, MRI, CT scans, and PET scans are fundamental for diagnosis, staging, and monitoring breast cancer.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Human Chorionic Gonadotropin (hCG) is a <strong>glycoprotein hormone</strong> produced primarily by the trophoblast cells of the placenta during pregnancy. It is detectable in blood and urine very early in pregnancy, serving as the basis for most pregnancy tests. In non-pregnant individuals, elevated hCG can be a significant <strong>Tumor Marker</strong> for certain germ cell tumors and gestational trophoblastic disease.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>AFP (Alpha-Fetoprotein):</strong> Often co-elevated with hCG in germ cell tumors, particularly non-seminomatous testicular cancer.</li>
            <li><strong>LDH (Lactate Dehydrogenase):</strong> Another non-specific tumor marker sometimes elevated in germ cell tumors.</li>
            <li><strong>Ultrasound:</strong> Essential for evaluating pregnancy complications or tumors.</li>
        </ul>
    `,
    relatedBiomarkers: ['Alpha-Fetoprotein (AFP)', 'Lactate Dehydrogenase (LDH)'] // Explicitly added LDH.
},
{
    ...
    detailedInfo: `
        ...
        <ul>
            ...
            <li><em>For standardization and better comparability between labs, PT results are often reported along with the <strong>International Normalized Ratio (INR)</strong>.</em></li>
        </ul>
        ...
        <h3>Additional Information:</h3>
        <p>PT is almost always ordered along with <strong>INR</strong> for monitoring warfarin. It is also often part of a <strong>Coagulogram</strong> (coagulation panel) which includes:</p>
        <ul>
            <li><strong>APTT (Activated Partial Thromboplastin Time):</strong> Evaluates the intrinsic and common pathways; used to monitor heparin.</li>
            <li><strong>Fibrinogen:</strong> Measures the concentration of clotting factor I.</li>
            <li><strong>Platelet Count:</strong> Assesses the number of platelets (involved in primary hemostasis).</li>
            <li><strong>D-Dimer:</strong> To assess for clot formation and breakdown (fibrinolysis).</li>
        </ul>
        <p>Interpreting PT requires considering the patient's medications, liver function, and overall clinical picture.</p>
    `,
    relatedBiomarkers: ['INR (International Normalized Ratio)', 'Activated Partial Thromboplastin Time (aPTT)', 'Fibrinogen', 'platelet-count', 'd-dimer'] // Expanded for full coag panel.
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>The International Normalized Ratio (INR) is a calculation that <strong>standardizes the results of the Prothrombin Time (PT)</strong>. It was developed to account for variations in reagents and equipment among different laboratories, ensuring that PT results are comparable worldwide. INR is a crucial <strong>Coagulation Marker</strong>, primarily used for monitoring oral anticoagulant therapy, especially with <strong>warfarin (Coumadin)</strong>.</p>
        ...
        <p>INR is directly derived from <strong>PT (Prothrombin Time)</strong>. Other related coagulation markers that might be assessed in a full <strong>Coagulogram</strong> include:</p>
        <ul>
            <li><strong>APTT (Activated Partial Thromboplastin Time):</strong> To assess intrinsic pathway, used for heparin monitoring.</li>
            <li><strong>Platelet Count and Function Tests.</strong></li>
            <li><strong>Fibrinogen and D-Dimer.</strong></li>
        </ul>
    `,
    relatedBiomarkers: ['Prothrombin Time (PT)', 'Activated Partial Thromboplastin Time (aPTT)', 'platelet-count', 'Fibrinogen', 'd-dimer'] // Expanded for full coag panel.
},
{
    ...
    detailedInfo: `
        ...
        <h3>Additional Information:</h3>
        <p>APTT is a key component of a <strong>Coagulogram</strong> (coagulation panel) and is often ordered alongside <strong>PT (Prothrombin Time)</strong> to assess both the intrinsic/common and extrinsic/common pathways. The results of PT and APTT help localize where a defect in the coagulation cascade might be occurring.</p>
        <p>Other related biomarkers include:</p>
        <ul>
            <li><strong>PT/INR:</strong> For the extrinsic pathway and warfarin monitoring.</li>
            <li><strong>Fibrinogen:</strong> To measure the concentration of Factor I.</li>
            <li><strong>Platelet Count:</strong> Assesses platelet number.</li>
            <li><strong>D-Dimer:</strong> To assess for active clot formation and breakdown.</li>
            <li><strong>Specific Factor Assays:</strong> If a factor deficiency is suspected (e.g., Factor VIII, Factor IX).</li>
        </ul>
    `,
    relatedBiomarkers: ['Prothrombin Time (PT)', 'INR (International Normalized Ratio)', 'Fibrinogen', 'd-dimer', 'platelet-count', 'factor-viii-assay', 'factor-ix-assay'] // Expanded for full coag panel and specific factor assays.
    },
    {
    id: 'Fibrinogen',
    name: 'Fibrinogen',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Fibrinogen (Factor I) is a <strong>soluble plasma glycoprotein</strong> synthesized in the liver. It is a critical component of the coagulation cascade, serving as the precursor to fibrin, which forms the structural meshwork of a blood clot. Fibrinogen is also an <strong>acute phase reactant</strong>, meaning its levels increase in response to inflammation, infection, and tissue injury.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Fibrinogen is often measured as part of a <strong>Coagulogram</strong> (coagulation panel) to assess overall clotting function, especially in bleeding disorders, liver disease, or before surgery. Its role as an inflammatory marker is also recognized.</p>
        <p>Related biomarkers in a coagulation panel include:</p>
        <ul>
            <li><strong>PT (Prothrombin Time):</strong> Evaluates extrinsic and common pathways.</li>
            <li><strong>APTT (Activated Partial Thromboplastin Time):</strong> Evaluates intrinsic and common pathways.</li>
            <li><strong>D-Dimer:</strong> Indicates fibrin breakdown; often elevated when clots are forming and breaking down.</li>
            <li><strong>Platelet Count:</strong> Assesses platelet number, which is crucial for primary hemostasis.</li>
        </ul>
    `,
    relatedBiomarkers: ['Prothrombin Time (PT)', 'Activated Partial Thromboplastin Time (aPTT)', 'D-dimer', 'platelet-count'] // Expanded to include D-dimer and Platelet Count as key coagulation panel components.
},
{
    id: 'D-dimer',
    name: 'D-dimer',
    ...
    detailedInfo: `
        ...
        <ul>
            <li><strong>PT (Prothrombin Time) and APTT (Activated Partial Thromboplastin Time):</strong> To assess global clotting pathways.</li>
            <li><strong>Fibrinogen:</strong> A precursor to fibrin; often consumed in DIC.</li>
            <li><strong>Platelet Count:</strong> Essential for clot formation.</li>
        </ul>
    `,
    relatedBiomarkers: ['Prothrombin Time (PT)', 'Activated Partial Thromboplastin Time (aPTT)', 'Fibrinogen', 'platelet-count'] 
},
{
    id: 'D-dimer (Coagulation)',
    name: 'D-dimer',
    description: 'A protein fragment produced when a blood clot dissolves. Indicates recent clotting activity.',
    type: 'Coagulation Marker',
    responsibleFor: 'Indicating the breakdown products of fibrin, suggesting recent or ongoing clot formation and lysis.',
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Serum Iron measures the amount of iron that is currently bound to transferrin (a transport protein) and circulating in the blood. It is an important <strong>Mineral / Nutritional Marker</strong> used to assess a patient's iron status.</p>
        ...
        <h3>Additional Information:</h3>
        <p>Serum iron is typically interpreted as part of a comprehensive <strong>Iron Panel</strong> (or iron studies), which includes:</p>
        <ul>
            <li><strong>Ferritin:</strong> The most reliable indicator of total body iron stores.</li>
            <li><strong>TIBC (Total Iron-Binding Capacity):</strong> Measures the capacity of transferrin to bind iron.</li>
            <li><strong>Transferrin Saturation:</strong> Calculated from serum iron and TIBC, indicating the percentage of transferrin that is saturated with iron.</li>
            <li><strong>CBC (Complete Blood Count):</strong> Especially Hemoglobin, Hematocrit, and MCV (Mean Corpuscular Volume), to assess for anemia.</li>
        </ul>
    `,
    relatedBiomarkers: ['Ferritin', 'Total Iron-Binding Capacity (TIBC)', 'transferrin-saturation', 'hemoglobin', 'hematocrit', 'Mean Corpuscular Volume (MCV)'] // Expanded to include Transferrin Saturation and CBC components.
},
{
    id: 'Total Iron-Binding Capacity (TIBC)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Total Iron-Binding Capacity (TIBC) is a laboratory test that measures the total amount of iron that can be bound by proteins in the blood, primarily <strong>transferrin</strong>. Transferrin is the main protein responsible for transporting iron throughout the body. TIBC is an indirect measure of the amount of transferrin available to bind iron and is a key component of a comprehensive <strong>Iron Panel</strong> for assessing iron status.</p>
        ...
        <h3>Additional Information:</h3>
        <p>TIBC is almost always interpreted as part of a complete <strong>Iron Panel</strong> for an accurate assessment of iron status. Transferrin saturation is a calculated value ($Transferrin\,Saturation = (\text{Serum Iron} / \text{TIBC}) \times 100\%$) that is often more informative than TIBC alone.</p>
        <p>Related biomarkers in iron studies include:</p>
        <ul>
            <li><strong>Serum Iron:</strong> Measures circulating iron.</li>
            <li><strong>Ferritin:</strong> Best indicator of iron stores.</li>
            <li><strong>Transferrin Saturation:</strong> Indicates how much of the transferrin is bound with iron.</li>
            <li><strong>CBC (Complete Blood Count):</strong> Especially Hemoglobin, Hematocrit, and MCV, to assess for anemia and red blood cell characteristics.</li>
        </ul>
    `,
    relatedBiomarkers: ['Serum Iron', 'Ferritin', 'transferrin-saturation', 'hemoglobin', 'hematocrit', 'Mean Corpuscular Volume (MCV)'] // Expanded for full iron panel and CBC components.
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Vitamin B12, also known as Cobalamin, is a <strong>water-soluble vitamin</strong> essential for numerous metabolic processes. It cannot be synthesized by the human body and must be obtained from the diet, primarily from animal products. It is a crucial <strong>Vitamin / Nutritional Marker</strong>.</p>
        ...
        <ul>
            <li><strong>Folic Acid (Folate):</strong> Often checked simultaneously as their deficiencies can cause similar anemia and interact.</li>
            <li><strong>MCV (Mean Corpuscular Volume):</strong> Typically elevated in megaloblastic anemia.</li>
            <li><strong>Homocysteine and Methylmalonic Acid (MMA):</strong> These are functional markers; elevated levels indicate intracellular B12 deficiency, even if serum B12 is borderline.</li>
            <li><strong>Intrinsic Factor Blocking Antibody / Parietal Cell Antibody:</strong> For pernicious anemia diagnosis.</li>
        </ul>
    `,
    relatedBiomarkers: ['Folic Acid (Folate)', 'Mean Corpuscular Volume (MCV)', 'Homocysteine', 'methylmalonic-acid', 'intrinsic-factor-antibody', 'parietal-cell-antibody'] // Expanded with MMA and antibody tests for cause.
},
{
    id: 'Folic Acid (Folate)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Folic Acid, or Folate (its natural form), is a <strong>water-soluble B vitamin (Vitamin B9)</strong> essential for various cellular processes, particularly those involving DNA synthesis and repair. It is crucial for rapidly dividing cells, such as those in the bone marrow. It is an important <strong>Vitamin / Nutritional Marker</strong>.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>Vitamin B12 (Cobalamin):</strong> Essential co-factor, checked alongside folate.</li>
            <li><strong>MCV (Mean Corpuscular Volume):</strong> Typically elevated in megaloblastic anemia due to large red blood cells.</li>
            <li><strong>Homocysteine:</strong> Elevated in both folate and B12 deficiency.</li>
        </ul>
    `,
    relatedBiomarkers: ['Vitamin B12 (Cobalamin)', 'Mean Corpuscular Volume (MCV)', 'Homocysteine']
},
{
    id: '25-OH Vitamin D (Calcidiol)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>25-Hydroxyvitamin D (25-OH Vitamin D), also known as calcidiol or calcifediol, is the major circulating form of Vitamin D in the blood and is considered the best indicator of overall Vitamin D status (from both sun exposure and dietary intake). It is a <strong>fat-soluble vitamin</strong>, which acts as a prohormone. It is a critical <strong>Vitamin / Nutritional Marker</strong>.</p>
        ...
        <ul>
            <li><strong>Calcium (Total and Ionized):</strong> Main mineral regulated by Vitamin D.</li>
            <li><strong>Phosphorus:</strong> Another mineral influenced by Vitamin D.</li>
            <li><strong>PTH (Parathyroid Hormone):</strong> Regulates calcium, phosphorus, and Vitamin D activation.</li>
            <li><strong>Alkaline Phosphatase (ALP):</strong> Can be elevated in bone disorders.</li>
        </ul>
    `,
    relatedBiomarkers: ['Calcium (Total)', 'Phosphorus (Phosphate)', 'Parathyroid Hormone (PTH)', 'alkaline-phosphatase'] // Added ALP.
},
{
    id: 'Zinc',
    name: 'Zinc',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Zinc is an <strong>essential trace element</strong> vital for numerous biological processes, acting as a cofactor for over 300 enzymes involved in metabolism, DNA replication, and protein synthesis. It is an important <strong>Trace Element / Nutritional Marker</strong>.</p>
        ...
        <ul>
            ...
            <li><strong>Copper Deficiency Anemia:</strong> High zinc interferes with copper absorption, leading to copper deficiency.</li>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>Copper:</strong> Zinc and copper metabolism are closely linked; high zinc can cause copper deficiency, and vice versa.</li>
            <li><strong>Alkaline Phosphatase (ALP):</strong> Zinc is a cofactor for ALP; severe zinc deficiency can lead to low ALP.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Copper is an <strong>essential trace element</strong> vital for the function of numerous enzymes (cuproenzymes) involved in critical biological processes. It is primarily transported in the blood bound to ceruloplasmin. It is an important <strong>Trace Element / Nutritional Marker</strong>.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>Zinc:</strong> Closely related in metabolism; imbalances can affect each other.</li>
            <li><strong>Ceruloplasmin:</strong> The main copper-transport protein; typically low in Wilson's disease.</li>
            <li><strong>24-hour Urinary Copper:</strong> Used in the diagnosis of Wilson's disease.</li>
            <li><strong>Liver Biopsy:</strong> For definitive diagnosis of copper accumulation in Wilson's disease or other liver conditions.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Selenium is an <strong>essential trace element</strong> that is incorporated into proteins to form selenoproteins, which play diverse and critical roles in human health. It is an important <strong>Trace Element / Nutritional Marker</strong>.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>TSH (Thyroid Stimulating Hormone), Free T3, Free T4:</strong> To assess thyroid function.</li>
            <li><strong>Iodine:</strong> Closely related to thyroid health.</li>
            <li><strong>Glutathione Peroxidase:</strong> An enzyme whose activity reflects selenium status.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        ...
        <ul>
            <li><strong>Fasting Plasma Glucose:</strong> Measures blood sugar after an overnight fast.</li>
            <li><strong>Random Plasma Glucose:</strong> Measures blood sugar at any time.</li>
            <li><strong>Oral Glucose Tolerance Test (OGTT):</strong> Measures glucose response to a sugary drink.</li>
            <li><strong>Insulin and C-peptide:</strong> To assess insulin production.</li>
            <li><strong>Fructosamine:</strong> Reflects average glucose over a shorter period (2-3 weeks).</li>
        </ul>
    `,
    relatedBiomarkers: ['glucose', 'Insulin', 'fructosamine', 'C-peptide'] // Expanded with Fructosamine and C-peptide.
},
{
    id: 'Lactate (Lactic Acid)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lactate, also known as lactic acid, is a byproduct of anaerobic metabolism, meaning it is produced when cells generate energy without sufficient oxygen. It is a critical <strong>Metabolic Marker</strong> used to assess tissue perfusion, oxygenation, and overall metabolic state, especially in critically ill patients.</p>
        ...
        <ul>
            <li><strong>Blood Gases (pH, pCO2, HCO3-):</strong> To assess the severity and type of metabolic acidosis.</li>
            <li><strong>Creatinine and BUN:</strong> To assess kidney function.</li>
            <li><strong>Liver Enzymes (ALT, AST, Bilirubin):</strong> To assess liver function.</li>
            <li><strong>CBC (Complete Blood Count):</strong> To assess for anemia or infection.</li>
            <li><strong>Cardiac Markers (Troponin, BNP):</strong> If heart failure or myocardial infarction is suspected.</li>
        </ul>
    `,
    relatedBiomarkers: ['blood-gases', 'creatinine', 'bun', 'Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'bilirubin', 'cbc', 'troponin', 'bnp'] // Expanded to include markers for assessing underlying causes of lactic acidosis.
},
{
    id: 'Ammonia',
    name: 'Ammonia',
    ...
    detailedInfo: `
        ...
        <ul>
            <li><strong>Liver Enzymes (ALT, AST, ALP, GGT):</strong> To assess liver cell damage and bile duct obstruction.</li>
            <li><strong>Bilirubin (Total and Direct):</strong> To assess liver's ability to process bilirubin.</li>
            <li><strong>Albumin:</strong> To assess liver's synthetic function (long-term).</li>
            <li><strong>PT/INR:</strong> To assess liver's synthetic function (short-term clotting factor production).</li>
            <li><strong>Imaging Studies:</strong> (e.g., ultrasound, CT, MRI) to evaluate liver structure.</li>
        </ul>
    `,
    relatedBiomarkers: ['bilirubin', 'Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'Alkaline Phosphatase (ALP)', 'Gamma-glutamyl transferase (GGT)', 'Albumin', 'Prothrombin Time (PT)', 'INR (International Normalized Ratio)'] // Expanded to include a more comprehensive set of liver function tests.
},
{
    id: 'Erythropoietin (EPO)',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Erythropoietin (EPO) is a <strong>glycoprotein hormone</strong> primarily produced by the kidneys (90%), with a small amount produced by the liver (10%). It is the principal regulator of red blood cell (RBC) production (erythropoiesis) in the bone marrow. EPO is a key <strong>Kidney Hormone</strong> and a central player in the body's response to oxygen demand.</p>
        ...
        <p>Related biomarkers include:</p>
        <ul>
            <li><strong>RBC, Hgb, Hct:</strong> Directly affected by EPO production.</li>
            <li><strong>Creatinine, eGFR:</strong> To assess kidney function.</li>
            <li><strong>Iron Panel (Ferritin, Serum Iron, TIBC):</strong> To rule out iron deficiency as a cause of anemia.</li>
            <li><strong>Vitamin B12 and Folate:</strong> To rule out megaloblastic anemia.</li>
            <li><strong>JAK2 V617F Mutation:</strong> For diagnosing Polycythemia Vera.</li>
        </ul>
    `,
    relatedBiomarkers: ['Red Blood Cell Count (RBC)', 'Hemoglobin (HGB)', 'Hematocrit (HCT)', 'creatinine', 'egfr', 'Ferritin', 'Serum Iron', 'Total Iron-Binding Capacity (TIBC)', 'Vitamin B12 (Cobalamin)', 'Folic Acid (Folate)', 'jak2-v617f'] // Expanded for full workup of anemia/polycythemia.
},
{
    id: 'Lead',
    name: 'Lead',
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Lead is a <strong>toxic heavy metal</strong> that has no known physiological role in the human body. It is an environmental contaminant that, upon exposure, can accumulate in the body and cause widespread toxicity. Blood Lead Level (BLL) is the primary <strong>Toxicology Marker</strong> used to assess recent or ongoing lead exposure.</p>
        ...
        <p>There is <strong>no known safe level of lead in blood</strong>, particularly for children. The Centers for Disease Control and Prevention (CDC) have defined a Blood Lead Reference Value (BLRV) to identify children with BLLs that are higher than most children in the U.S.</p>
        <ul>
        ...
        <ul>
            <li><strong>CBC (Complete Blood Count):</strong> Lead can cause microcytic hypochromic anemia with basophilic stippling.</li>
            <li><strong>Erythrocyte Protoporphyrin (EP) / Zinc Protoporphyrin (ZPP):</strong> These are elevated in lead poisoning and iron deficiency; they reflect lead's interference with heme synthesis.</li>
            <li><strong>Kidney Function Tests (Creatinine, BUN):</strong> To assess lead's impact on kidneys.</li>
            <li><strong>Neurodevelopmental Assessments:</strong> Especially in children.</li>
        </ul>
    `,
...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Cyclosporine (also spelled ciclosporin) is a <strong>calcineurin inhibitor (CNI)</strong>, a potent immunosuppressant medication. It works by inhibiting the activation of T-lymphocytes, thereby suppressing the immune response. It is a critical <strong>Therapeutic Drug Monitoring (TDM)</strong> marker, meaning its blood levels are closely measured to ensure efficacy while minimizing toxicity.</p>
        ...
        <ul>
            <li><strong>Tacrolimus:</strong> Another calcineurin inhibitor, often used interchangeably or in combination with cyclosporine.</li>
            <li><strong>Creatinine and BUN:</strong> To monitor kidney function (major toxicity target).</li>
            <li><strong>ALT, AST, Bilirubin:</strong> To monitor liver function.</li>
            <li><strong>Electrolytes (Potassium, Magnesium):</strong> Affected by cyclosporine.</li>
            <li><strong>White Blood Cell Count (WBC):</strong> To monitor for infection (due to immunosuppression).</li>
            <li><strong>Organ-specific Function Tests:</strong> (e.g., liver function tests for liver transplant, cardiac enzymes for heart transplant).</li>
        </ul>
    `,
    relatedBiomarkers: ['Tacrolimus (Drug Level)', 'creatinine', 'bun', 'Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'bilirubin', 'Potassium', 'Magnesium', 'White Blood Cell Count (WBC)'] // Expanded for more comprehensive monitoring.
},
{
    id: 'Tacrolimus (Drug Level)',
    ...
    detailedInfo: `
        ...
        <p>Like cyclosporine, tacrolimus has a narrow therapeutic index and significant variability in its absorption and metabolism between individuals. Therefore, routine blood level monitoring is essential. Levels are typically measured as <strong>trough levels</strong>, meaning the sample is drawn just before the next scheduled dose, to ensure the lowest effective concentration is maintained in the body.</p>
        ...
        <ul>
            <li><strong>Cyclosporine:</strong> The other main calcineurin inhibitor, though usually only one is used at a time.</li>
            <li><strong>Creatinine and BUN:</strong> To monitor kidney function (major toxicity target).</li>
            <li><strong>ALT, AST, Bilirubin:</strong> To monitor liver function.</li>
            <li><strong>Blood Glucose / HbA1c:</strong> To monitor for new-onset diabetes.</li>
            <li><strong>Electrolytes (Potassium):</strong> Affected by tacrolimus.</li>
            <li><strong>White Blood Cell Count (WBC):</strong> To monitor for infection (due to immunosuppression).</li>
            <li><strong>Organ-specific Function Tests:</strong> To assess graft health.</li>
        </ul>
    `,
    relatedBiomarkers: ['Cyclosporine (Drug Level)', 'creatinine', 'bun', 'Alanine Aminotransferase (ALT)', 'Aspartate Aminotransferase (AST)', 'bilirubin', 'glucose', 'Glycated Hemoglobin (HbA1c)', 'Potassium', 'White Blood Cell Count (WBC)'] // Expanded for more comprehensive monitoring.
}
];

...
},
{
    ...
    detailedInfo: `
        <h3>Biomarker Type:</h3>
        <p>Chloride (Cl$^-$) is the most abundant anion (negatively charged ion) in the extracellular fluid. It is crucial for maintaining the body's fluid balance and acid-base balance. It is routinely measured as part of an <strong>Electrolyte</strong> panel, along with sodium and potassium.</p>
...
},
{
    ...
    `,
    relatedBiomarkers: ['crp', 'esr', 'anti-ccp-antibodies'] 
},
{
    id: 'iga',

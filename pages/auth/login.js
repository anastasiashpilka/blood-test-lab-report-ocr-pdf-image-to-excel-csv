...
import { signInWithEmail, signInWithGoogle, sendPasswordReset, getAuthErrorMessage } from '../../firebase/auth';
...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign In — Blood Test Converter</title>
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
          ...
          <button
            ...
            className="text-sm text-indigo-600 hover:underline mb-4 block text-center w-full"
          >
            Forgot password?
          </button>

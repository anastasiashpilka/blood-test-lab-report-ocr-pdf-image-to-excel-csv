...
"Glucose": "Glucosa",
    ...
    units: {
      ...
      "nmol/L": "nmol/L"
        ...
        myTestsPage: {
            pageTitle: "Meine Tests — Blood Test Converter",
            back: "Zurück",
            heading: "Meine Tests",
            newConversion: "+ Neue Konvertierung",
            loadError: "Ihre Tests konnten nicht geladen werden",
            loadErrorHint: "Überprüfen Sie die Browserkonsole. Dies ist normalerweise ein Problem mit den Firestore-Sicherheitsregeln.",
            noTests: "Noch keine gespeicherten Tests.",
            uploadFirst: "Laden Sie Ihren ersten Bluttest hoch →",
            untitled: "Unbenannter Test",
            biomarkers: "Biomarker",
            outOfRange: "außerhalb des Bereichs",
            allInRange: "Alle im Bereich",
            improved: "verbessert",
            ...
            backToTests: "Zurück zu meinen Tests",
            whatDoResultsMean: "Was bedeuten Ihre Ergebnisse?",
            analyzingResults: "Ihre Ergebnisse werden analysiert…",
            disclaimer: "Nur zur Information. Konsultieren Sie immer einen Arzt.",
            copied: "Kopiert!",
            copyTable: "Tabelle kopieren",
            downloaded: "Heruntergeladen!",
            downloadCsv: "CSV herunterladen",
            compareMode: "Vergleichen",
            selectTwoTests: "2 Tests auswählen",
            compareSelected: "Vergleichen",
            unchanged: "unverändert",
            showRawData: "Rohdaten anzeigen",
            hideRawData: "Rohdaten ausblenden",
            comparingWith: "Vergleich mit",
        },
    },
    fr: {
        header: {
       ...
       howItWorks: {
        ...
        faq: {
            ...
            a1: "Oui, nous prenons vos données au sérieux. Votre fichier téléchargé n'est jamais stocké sur nos serveurs — tout le traitement des fichiers est temporaire et s'effectue uniquement en mémoire. Le contenu de votre fichier est envoyé à Google Gemini AI pour extraction et interprétation, et est soumis à la politique de confidentialité de Google. Si vous choisissez de sauvegarder vos résultats, ils sont stockés en toute sécurité dans votre compte privé via Firebase. Pour plus de détails, consultez notre <a href=\"/privacy-policy\" class=\"text-indigo-600 hover:underline font-medium\">politique de confidentialité</a>.",
        ...
        nav: {
            ...
            signIn: 'Se connecter',
            signUp: "S'inscrire",
            myTests: 'Mes analyses',
            signOut: 'Se déconnecter',
            menu: 'Menu',
        },
        footerSection: {
            tagline: "Convertisseur médical gratuit propulsé par l'IA.",
            privacy: "Vos données ne sont jamais stockées sur nos serveurs.",
            toolsHeading: "Outils",
            infoHeading: "Infos",
            bloodTestConverter: "Convertisseur d'Analyses de Sang",
            unitConverter: "Convertisseur d'Unités",
            biomarkerHub: "Centre des Biomarqueurs",
            about: "À propos",
    ...
    units: {
      ...
      "nmol/L": "nmol/L"
        ...
        myTestsPage: {
            pageTitle: "Mes analyses — Blood Test Converter",
            back: "Retour",
            heading: "Mes analyses",
            newConversion: "+ Nouvelle conversion",
            loadError: "Impossible de charger vos analyses",
            loadErrorHint: "Vérifiez la console du navigateur. Il s'agit généralement d'un problème de règles de sécurité Firestore.",
            noTests: "Aucune analyse sauvegardée pour l'instant.",
            uploadFirst: "Téléchargez votre première analyse sanguine →",
            untitled: "Analyse sans titre",
            biomarkers: "biomarqueurs",
            outOfRange: "hors plage",
            allInRange: "Tout dans la plage",
            improved: "amélioré",
            worsened: "aggravé",
            ...
            delete: "Supprimer",
            cancel: "Annuler",
            testNotFound: "Analyse introuvable.",
            backToTests: "Retour à mes analyses",
            whatDoResultsMean: "Que signifient vos résultats ?",
            analyzingResults: "Analyse de vos résultats…",
            disclaimer: "Informatif uniquement. Consultez toujours un professionnel de santé.",
            copied: "Copié !",
            copyTable: "Copier le tableau",
            downloaded: "Téléchargé !",
            downloadCsv: "Télécharger CSV",
            compareMode: "Comparer",
            selectTwoTests: "Sélectionner 2 analyses",
            compareSelected: "Comparer",
            unchanged: "inchangé",
            showRawData: "Voir données brutes",
            hideRawData: "Masquer données",
            comparingWith: "Comparaison avec",
        },
    },
    uk: {
        header: {
    ...
    step3: {
        ...
        faq: {
            ...
            a1: "Так, ми серйозно ставимося до ваших даних. Завантажений файл ніколи не зберігається на наших серверах — вся обробка файлів є тимчасовою та відбувається лише в оперативній пам'яті. Вміст вашого файлу надсилається до Google Gemini AI для вилучення та інтерпретації і підпадає під політику конфіденційності Google. Якщо ви вирішите зберегти результати, вони надійно зберігаються у вашому приватному обліковому записі за допомогою Firebase. Для детальної інформації ознайомтеся з нашою <a href=\"/privacy-policy\" class=\"text-indigo-600 hover:underline font-medium\">політикою конфіденційності</a>.",
        ...
        footerSection: {
            tagline: "Безкоштовний медичний конвертер на базі ШІ.",
            privacy: "Ваші дані ніколи не зберігаються на наших серверах.",
            toolsHeading: "Інструменти",
            infoHeading: "Інфо",
            bloodTestConverter: "Конвертер аналізів крові",
            unitConverter: "Конвертер одиниць",
            biomarkerHub: "Центр біомаркерів",
            about: "Про нас",
...
"Glucose": "Глюкоза",
    ...
    units: {
      ...
      "nmol/L": "нмоль/л"
        ...
        languageSelect: "Мова",
        myTestsPage: {
            pageTitle: "Мої аналізи — Blood Test Converter",
            back: "Назад",
            heading: "Мої аналізи",
            newConversion: "+ Нова конвертація",
            loadError: "Не вдалося завантажити ваші аналізи",
            loadErrorHint: "Перевірте консоль браузера. Зазвичай це проблема з правилами безпеки Firestore.",
            noTests: "Збережених аналізів ще немає.",
            uploadFirst: "Завантажте перший аналіз крові →",
            untitled: "Аналіз без назви",
            biomarkers: "біомаркери",
            outOfRange: "поза нормою",
            allInRange: "Усі в нормі",
            improved: "покращилось",
            worsened: "погіршилось",
            noChange: "Без змін",
            deleteConfirm: "Видалити?",
            delete: "Видалити",
            cancel: "Скасувати",
            testNotFound: "Аналіз не знайдено.",
            backToTests: "Повернутися до моїх аналізів",
            whatDoResultsMean: "Що означають ваші результати?",
            analyzingResults: "Аналіз ваших результатів…",
            disclaimer: "Лише для інформації. Завжди консультуйтеся з лікарем.",
            copied: "Скопійовано!",
            copyTable: "Копіювати таблицю",
            downloaded: "Завантажено!",
            downloadCsv: "Завантажити CSV",
            compareMode: "Порівняти",
            selectTwoTests: "Вибрати 2 аналізи",
            compareSelected: "Порівняти",
            unchanged: "без змін",
            showRawData: "Показати дані",
            hideRawData: "Приховати дані",
            comparingWith: "Порівняння з",
        },
    },
    ja: {
        header: {
        ...
        faq: {
            title: "よくある質問（FAQ）",
            q1: "私の医療データは安全ですか？",
            a1: "はい、データの取り扱いを重視しています。アップロードされたファイルは当社のサーバーに保存されません — すべてのファイル処理は一時的で、メモリ上でのみ行われます。ファイルの内容は抽出・解釈のためGoogle Gemini AIに送信され、Googleのプライバシーポリシーが適用されます。結果を保存する場合、Firebaseを使用してプライベートアカウントに安全に保管されます。詳細については、<a href=\"/privacy-policy\" class=\"text-indigo-600 hover:underline font-medium\">プライバシーポリシー</a>をご覧ください。",
        ...
        footerSection: {
            tagline: "無料のAI医療データコンバーター。",
            privacy: "お客様のデータは当社のサーバーに保存されません。",
            toolsHeading: "ツール",
            infoHeading: "情報",
            bloodTestConverter: "血液検査コンバーター",
            unitConverter: "単位コンバーター",
            biomarkerHub: "バイオマーカーハブ",
            about: "概要",
  ...
  step3: {
    ...
    units: {
      ...
      "nmol/L": "nmol/L"
        ...
        languageSelect: "言語",
        myTestsPage: {
            pageTitle: "マイテスト — Blood Test Converter",
            back: "戻る",
            heading: "マイテスト",
            newConversion: "+ 新規変換",
            loadError: "テストを読み込めませんでした",
            loadErrorHint: "ブラウザのコンソールを確認してください。通常、Firestoreのセキュリティルールの問題です。",
            noTests: "保存されたテストはまだありません。",
            uploadFirst: "最初の血液検査をアップロード →",
            untitled: "タイトルなし",
            biomarkers: "バイオマーカー",
            outOfRange: "範囲外",
            allInRange: "すべて範囲内",
            ...
            backToTests: "マイテストに戻る",
            whatDoResultsMean: "結果はどういう意味ですか？",
            analyzingResults: "結果を分析中…",
            disclaimer: "情報提供のみです。常に医療専門家に相談してください。",
            copied: "コピーしました！",
            copyTable: "表をコピー",
            downloaded: "ダウンロードしました！",
            downloadCsv: "CSVをダウンロード",
            compareMode: "比較",
            selectTwoTests: "2つのテストを選択",
            compareSelected: "比較する",
            unchanged: "変化なし",
            showRawData: "生データを表示",
            hideRawData: "非表示",
            comparingWith: "比較対象",
...
zh: {
        ...
        faq: {
            title: "常见问题 (FAQ)",
            q1: "我的医疗数据安全吗？",
            a1: "是的，我们认真对待您的数据。上传的文件永远不会存储在我们的服务器上 — 所有文件处理都是临时的，仅在内存中进行。您的文件内容将发送至Google Gemini AI进行提取和解释，并受Google隐私政策约束。如果您选择保存结果，它们将通过Firebase安全存储在您的私人账户中。有关详细信息，请阅读我们的<a href=\"/privacy-policy\" class=\"text-indigo-600 hover:underline font-medium\">隐私政策</a>。",
            q2: "我可以转换哪些类型的血液检测？",
        ...
        footerSection: {
            tagline: "免费AI驱动的医疗数据转换器。",
            privacy: "您的数据绝不会存储在我们的服务器上。",
            toolsHeading: "工具",
            infoHeading: "信息",
            bloodTestConverter: "血液检测转换器",
            unitConverter: "单位转换器",
            biomarkerHub: "生物标志物中心",
            about: "关于我们",
            privacyData: "隐私与数据",
        },
       unitConverter: {
    ...
    units: {
      ...
      "nmol/L": "纳摩尔/升"
        ...
        languageSelect: "语言选择",
        myTestsPage: {
            pageTitle: "我的检测 — Blood Test Converter",
            back: "返回",
            heading: "我的检测",
            newConversion: "+ 新建转换",
            loadError: "无法加载您的检测记录",
            loadErrorHint: "请查看浏览器控制台。通常是Firestore安全规则问题。",
            noTests: "暂无已保存的检测。",
            uploadFirst: "上传您的第一份血液检测 →",
            untitled: "未命名检测",
            biomarkers: "项生物标志物",
            outOfRange: "超出范围",
            allInRange: "全部正常",
            ...
            delete: "删除",
            cancel: "取消",
            testNotFound: "未找到检测记录。",
            backToTests: "返回我的检测",
            whatDoResultsMean: "您的结果意味着什么？",
            analyzingResults: "正在分析您的结果…",
            disclaimer: "仅供参考。请始终咨询医疗专业人员。",
            copied: "已复制！",
            copyTable: "复制表格",
            downloaded: "已下载！",
            downloadCsv: "下载CSV",
            compareMode: "对比",
            selectTwoTests: "选择2项检测",
            compareSelected: "对比",
            unchanged: "未变化",
            showRawData: "显示原始数据",
            hideRawData: "隐藏数据",
